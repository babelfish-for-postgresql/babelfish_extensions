...
coll_info coll_infos[] =
{
  ...
  // {0, "bbf_unicode_cp1252_ci_ai",      1033, 0, 196608, 54, 0x000f, 1252, PG_WIN1252},
  // {0, "bbf_unicode_cp1252_ci_as",      1033, 0, 196608, 52, 0x000d, 1252, PG_WIN1252},
  // {0, "bbf_unicode_cp1252_cs_ai",      1033, 0, 196608, 51, 0x000e, 1252, PG_WIN1252},
  // {0, "bbf_unicode_cp1252_cs_as",      1033, 0, 196608, 51, 0x000c, 1252, PG_WIN1252},
  ...
  /* For the bbf_unicode_general collations, set lcid and codepage based on babelfishpg_tsql.default_locale */
 ...
 * - check_for_ci_as_collation = false: returns true if the expression contains an ILIKE
 * node
 */
	...
	)
{
	...
	if (default_locale && strlen(default_locale) > 0)
	{
		 ...
		 * prepend the babelfishpg_tsql_default_locale to the specified locale.
