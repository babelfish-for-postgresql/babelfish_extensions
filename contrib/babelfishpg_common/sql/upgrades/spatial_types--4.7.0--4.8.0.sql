...
BEGIN
    ALTER FUNCTION sys.GeographyAsTextbp_helper(sys.GEOGRAPHY) RENAME TO geographyastextbp_helper_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'geographyastextbp_helper_deprecated_4_8_0');
...
DECLARE	
    exception_message text;	
BEGIN	
	ALTER FUNCTION sys.bpchar(sys.GEOGRAPHY) RENAME TO bpchar_geog_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'bpchar_geog_deprecated_4_8_0');
...
DECLARE	
    exception_message text;	
BEGIN	
	ALTER FUNCTION sys.varchar(sys.GEOGRAPHY) RENAME TO varchar_geog_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'varchar_geog_deprecated_4_8_0');
...
DECLARE	
    exception_message text;	
BEGIN	
	ALTER FUNCTION sys.bbf_varbinary(sys.GEOGRAPHY) RENAME TO bbf_varbinary_geog_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'bbf_varbinary_geog_deprecated_4_8_0');
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.Geography__stgeomfromtext(text, integer) RENAME TO geography__stgeomfromtext_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'geography__stgeomfromtext_deprecated_4_8_0');
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.STAsText_common(sys.GEOGRAPHY) RENAME TO stastext_common_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'stastext_common_deprecated_4_8_0');
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.STAsText(sys.GEOGRAPHY) RENAME TO stastext_geog_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'stastext_geog_deprecated_4_8_0');
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.STAsBinary(sys.GEOGRAPHY) RENAME TO stasbinary_geog_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'stasbinary_geog_deprecated_4_8_0');
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.Geography__STPointFromText(text, integer) RENAME TO geography__stpointfromtext_deprecated_4_8_0;
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.Geometry__stgeomfromtext(text, integer) RENAME TO geometry__stgeomfromtext_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'geometry__stgeomfromtext_deprecated_4_8_0');
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.STAsText(sys.GEOMETRY) RENAME TO stastext_geom_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'stastext_geom_deprecated_4_8_0');
...
DECLARE	
    exception_message text;	
BEGIN	
	ALTER FUNCTION sys.bpchar(sys.GEOMETRY) RENAME TO bpchar_geom_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'bpchar_geom_deprecated_4_8_0');
...
DECLARE	
    exception_message text;	
BEGIN	
	ALTER FUNCTION sys.varchar(sys.GEOMETRY) RENAME TO varchar_geom_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'varchar_geom_deprecated_4_8_0');
...
DECLARE	
    exception_message text;	
BEGIN	
	ALTER FUNCTION sys.bbf_varbinary(sys.GEOMETRY) RENAME TO bbf_varbinary_geom_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'bbf_varbinary_geom_deprecated_4_8_0');
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.Geometry__STPointFromText(text, integer) RENAME TO geometry__stpointfromtext_deprecated_4_8_0;
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.STAsBinary(sys.GEOMETRY) RENAME TO stasbinary_geom_deprecated_4_8_0;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'stasbinary_geom_deprecated_4_8_0');
