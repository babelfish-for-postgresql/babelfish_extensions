-- 1 "sql/upgrades/babelfishpg_upgrades.in"
-- 1 "<built-in>"
-- 1 "<command-line>"
...
-- 1 "sql/upgrades/spatial_types.sql" 1
-------------------------------------------------------
...
CREATE OR REPLACE FUNCTION sys.STDistance_helper(geog1 sys.GEOGRAPHY, geog2 sys.GEOGRAPHY)
 ...
 LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE;
-- 10 "sql/upgrades/babelfishpg_upgrades.in" 2

-- 1 "sql/upgrades/other_types.sql" 1
------------------------------------------------------------------------------
---- Include changes related to other datatypes except spatial types here ----
------------------------------------------------------------------------------
-- 12 "sql/upgrades/babelfishpg_upgrades.in" 2
