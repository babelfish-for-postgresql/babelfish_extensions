...
-- =============================================================
-- Performance optimization for spatial (geometry/geography) functions
-- (#4827 / BABEL-6444). Reimplements the wrappers as C functions with
-- header-only fast paths and trivial-validity short-circuits. Ported
-- from the 5.x spatial_types--5.6.0--5.7.0 step into the 6.x chain.
-- T-SQL semantics (validity error contract, NULL-on-mismatched-SRID) preserved.
-- =============================================================
-- =============================================================
-- GEOMETRY
-- =============================================================
