...
Babelfish has introduced a new extension named babelfishpg_unit which enables us to run unit tests. Please follow the README.md file present in contrib/README.md. Once we have built and installed the extension, we are ready to write unit tests. 
...
As we can see, test_1.c, test_2.c, ... are the individual test files which contains the test cases to a particular area of functionality or component being tested.
