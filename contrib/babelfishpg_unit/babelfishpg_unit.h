...
extern TestResult *test_pltsql_GetNewTempObjectId(void);
extern TestResult *test_pltsql_GetNewTempObjectId_tempOidStartSet(void);
extern TestResult *test_pltsql_GetNewTempObjectId_oidCount(void);
extern TestResult *test_pltsql_GetNewTempObjectId_endWraparound(void);
extern TestResult *test_pltsql_GetNewTempObjectId_endBuffer(void);
extern TestResult *test_pltsql_GetNewTempOidWithIndex(void);
extern TestResult *test_pltsql_GetNewTempOidWithIndex_endBuffer(void);
