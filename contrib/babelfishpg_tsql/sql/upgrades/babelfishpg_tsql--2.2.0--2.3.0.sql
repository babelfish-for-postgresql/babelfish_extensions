...
CREATE OR REPLACE VIEW information_schema_tsql.SEQUENCES AS
    SELECT CAST(nc.dbname AS sys.nvarchar(128)) AS "SEQUENCE_CATALOG",
            ...
            CAST(s.seqstart AS bigint) AS "START_VALUE",
            CAST(s.seqmin AS bigint) AS "MINIMUM_VALUE",
            CAST(s.seqmax AS bigint) AS "MAXIMUM_VALUE",
            CAST(s.seqincrement AS bigint) AS "INCREMENT",
