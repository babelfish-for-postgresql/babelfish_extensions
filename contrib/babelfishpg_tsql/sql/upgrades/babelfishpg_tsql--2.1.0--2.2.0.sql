...
AND NOT a.attisdropped AND (pg_has_role(ss.relowner, CAST('USAGE' AS text)) 
OR has_column_privilege(ss.roid, a.attnum, CAST('SELECT, INSERT, UPDATE, REFERENCES' AS text)));
