...
-- deprecate views dependent on tsql_stat_get_activity
ALTER VIEW sys.dm_exec_sessions RENAME TO dm_exec_sessions_deprecated_2_1;
ALTER VIEW sys.dm_exec_connections RENAME TO dm_exec_connections_deprecated_2_1;
...
create or replace view sys.dm_exec_sessions_deprecated_2_1
  as
  ...
  RIGHT JOIN sys.tsql_stat_get_activity_deprecated_2_1('sessions') AS d ON (a.pid = d.procid);
GRANT SELECT ON sys.dm_exec_sessions_deprecated_2_1 TO PUBLIC;

create or replace view sys.dm_exec_connections_deprecated_2_1
 as
 select a.pid as session_id
 ...
 from pg_catalog.pg_stat_activity AS a
 RIGHT JOIN sys.tsql_stat_get_activity_deprecated_2_1('connections') AS d ON (a.pid = d.procid);
 GRANT SELECT ON sys.dm_exec_connections_deprecated_2_1 TO PUBLIC;
