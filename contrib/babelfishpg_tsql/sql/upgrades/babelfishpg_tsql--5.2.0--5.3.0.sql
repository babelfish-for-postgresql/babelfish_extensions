...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.charindex(PG_CATALOG.TEXT, PG_CATALOG.TEXT, INTEGER) RENAME TO fn_charindex_deprecated_in_5_3_0;
EXCEPTION WHEN OTHERS THEN
    GET STACKED DIAGNOSTICS
    exception_message = MESSAGE_TEXT;
    RAISE WARNING '%', exception_message;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'fn_charindex_deprecated_in_5_3_0');
