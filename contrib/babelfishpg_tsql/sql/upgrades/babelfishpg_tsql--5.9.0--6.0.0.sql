...
\echo Use "ALTER EXTENSION ""babelfishpg_tsql"" UPDATE TO '6.0.0'" to load this file. \quit
...
BEGIN
    ALTER FUNCTION sys.babelfish_conv_helper_to_varbinary(typmod integer, arg sys."varchar", try boolean, p_style numeric) RENAME TO babelfish_conv_helper_to_varbinary_varchar_deprecated_in_6_0_0;
...
END;
$$;
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_conv_helper_to_varbinary_varchar_deprecated_in_6_0_0');

DO $$
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.babelfish_try_conv_string_to_varbinary(arg sys."varchar", p_style numeric) RENAME TO babelfish_try_conv_string_to_varbinary_varchar_deprecated_in_6_0_0;
EXCEPTION WHEN OTHERS THEN
    GET STACKED DIAGNOSTICS
    exception_message = MESSAGE_TEXT;
    RAISE WARNING '%', exception_message;
END;
$$;
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_try_conv_string_to_varbinary_varchar_deprecated_in_6_0_0');

DO $$
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.babelfish_conv_string_to_varbinary(IN input_value sys.VARCHAR, IN p_style NUMERIC) RENAME TO babelfish_conv_string_to_varbinary_deprecated_in_6_0_0;
EXCEPTION WHEN OTHERS THEN
    GET STACKED DIAGNOSTICS
    exception_message = MESSAGE_TEXT;
    RAISE WARNING '%', exception_message;
END;
$$;
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_conv_string_to_varbinary_deprecated_in_6_0_0');
...
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.babelfish_conv_helper_to_binary(typmod integer, arg sys."varchar", try boolean, p_style numeric) RENAME TO babelfish_conv_helper_to_binary_varchar_deprecated_in_6_0_0;
EXCEPTION WHEN OTHERS THEN
    GET STACKED DIAGNOSTICS
    exception_message = MESSAGE_TEXT;
    RAISE WARNING '%', exception_message;
END;
$$;
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_conv_helper_to_binary_varchar_deprecated_in_6_0_0');

DO $$
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.babelfish_try_conv_string_to_binary(arg sys."varchar", p_style numeric) RENAME TO babelfish_try_conv_string_to_binary_varchar_deprecated_in_6_0_0;
EXCEPTION WHEN OTHERS THEN
    GET STACKED DIAGNOSTICS
    exception_message = MESSAGE_TEXT;
    RAISE WARNING '%', exception_message;
END;
$$;
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_try_conv_string_to_binary_varchar_deprecated_in_6_0_0');

DO $$
DECLARE
    exception_message text;
BEGIN
    ALTER FUNCTION sys.babelfish_conv_string_to_binary(IN input_value sys.VARCHAR, IN p_style NUMERIC) RENAME TO babelfish_conv_string_to_binary_deprecated_in_6_0_0;
EXCEPTION WHEN OTHERS THEN
    GET STACKED DIAGNOSTICS
    exception_message = MESSAGE_TEXT;
    RAISE WARNING '%', exception_message;
END;
$$;
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_conv_string_to_binary_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_try_conv_date_to_string_deprecated_in_6_0_0;
EXCEPTION
...
END;
$$;
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_try_conv_date_to_string_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_try_conv_datetime_to_string_deprecated_in_6_0_0;
EXCEPTION
    WHEN undefined_function THEN
        GET STACKED DIAGNOSTICS
        exception_message = MESSAGE_TEXT;
...
END;
$$;
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_try_conv_datetime_to_string_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_try_conv_time_to_string_deprecated_in_6_0_0;
EXCEPTION
    WHEN undefined_function THEN
        GET STACKED DIAGNOSTICS
        exception_message = MESSAGE_TEXT;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_try_conv_time_to_string_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_conv_helper_to_varchar_with_text_argument_deprecated_in_6_0_0;
EXCEPTION
    WHEN undefined_function THEN
        GET STACKED DIAGNOSTICS
        exception_message = MESSAGE_TEXT;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_conv_helper_to_varchar_with_text_argument_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_conv_helper_to_varchar_deprecated_in_6_0_0;
EXCEPTION
    WHEN undefined_function THEN
        GET STACKED DIAGNOSTICS
        exception_message = MESSAGE_TEXT;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_conv_helper_to_varchar_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_try_conv_to_varchar_deprecated_in_6_0_0;
EXCEPTION
    WHEN undefined_function THEN
        GET STACKED DIAGNOSTICS
        exception_message = MESSAGE_TEXT;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_try_conv_to_varchar_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_conv_to_varchar_deprecated_in_6_0_0;
EXCEPTION
    WHEN undefined_function THEN
        GET STACKED DIAGNOSTICS
        exception_message = MESSAGE_TEXT;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_conv_to_varchar_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_try_conv_money_to_string_deprecated_in_6_0_0;
EXCEPTION
    WHEN undefined_function THEN
        GET STACKED DIAGNOSTICS
        exception_message = MESSAGE_TEXT;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_try_conv_money_to_string_deprecated_in_6_0_0');
...
BEGIN
    ...
    RENAME TO babelfish_try_conv_float_to_string_deprecated_in_6_0_0;
EXCEPTION
    WHEN undefined_function THEN
        GET STACKED DIAGNOSTICS
        exception_message = MESSAGE_TEXT;
...
CALL sys.babelfish_drop_deprecated_object('function', 'sys', 'babelfish_try_conv_float_to_string_deprecated_in_6_0_0');
