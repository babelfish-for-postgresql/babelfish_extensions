...
ALTER PROCEDURE sys.sp_describe_undeclared_parameters RENAME TO sys.sp_describe_undeclared_parameters_deprecated_1_2;
...
-- Need to rename and recreate the object due to previous incorrect definition.
ALTER FUNCTION sys.checksum RENAME TO sys.checksum_deprecated_1_2;
...
-- Need to rename and recreate the object due to previous incorrect definition.
ALTER FUNCTION sys.babelfish_inconsistent_metadata RENAME TO sys.babelfish_inconsistent_metadata_1_2;
