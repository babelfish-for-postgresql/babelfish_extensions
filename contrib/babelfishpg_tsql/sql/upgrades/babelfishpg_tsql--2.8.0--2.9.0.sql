...
BEGIN
    ...
    -- update body of babelfish_conv_string_to_date_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_conv_string_to_date_deprecated_4_2(IN p_datestring TEXT,
    ...
    BEGIN
        ...
        THEN
            v_fractsecs := coalesce(sys.babelfish_get_timeunit_from_string_deprecated_4_2(v_datestring, 'FRACTSECONDS'), '');
    ...
    -- update body of babelfish_try_conv_string_to_date_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_try_conv_string_to_date_deprecated_4_2(IN p_datestring TEXT,
                                                                                IN p_style NUMERIC DEFAULT 0)
    RETURNS DATE
    AS
    $BODY$
    BEGIN
        RETURN sys.babelfish_conv_string_to_date_deprecated_4_2(p_datestring,
                                                            p_style);
    EXCEPTION
        WHEN OTHERS THEN
            RETURN NULL;
    ...
    -- update body of babelfish_try_conv_string_to_date_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_conv_helper_to_date_deprecated_4_2(IN arg TEXT,
                                                            IN try BOOL,
                                                            IN p_style NUMERIC DEFAULT 0)
    RETURNS DATE
    AS
    ...
    BEGIN
        IF try THEN
            RETURN sys.babelfish_try_conv_string_to_date_deprecated_4_2(arg, p_style);
        ELSE
            RETURN sys.babelfish_conv_string_to_date_deprecated_4_2(arg, p_style);
        END IF;
    END;
    $BODY$
    LANGUAGE plpgsql
    ...
    -- update body of babelfish_conv_string_to_time_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_conv_string_to_time_deprecated_4_2(IN p_datatype TEXT,
    ...
    BEGIN
        ...
        v_fseconds := sys.babelfish_get_microsecs_from_fractsecs_deprecated_4_2(v_fseconds, v_scale);
    ...
    -- update body of babelfish_try_conv_string_to_time_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_try_conv_string_to_time_deprecated_4_2(IN p_datatype TEXT,
                                                                                IN p_timestring TEXT,
                                                                                IN p_style NUMERIC DEFAULT 0)
    RETURNS TIME WITHOUT TIME ZONE
    AS
    $BODY$
    BEGIN
        RETURN sys.babelfish_conv_string_to_time_deprecated_4_2(p_datatype,
                                                            p_timestring,
                                                            p_style);
    EXCEPTION
        WHEN OTHERS THEN
    ...
    -- update body of babelfish_conv_helper_to_time_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_conv_helper_to_time_deprecated_4_2(IN arg TEXT,
                                                            IN try BOOL,
                                                            IN p_style NUMERIC DEFAULT 0)
    RETURNS TIME
    AS
    ...
    BEGIN
        IF try THEN
            RETURN sys.babelfish_try_conv_string_to_time_deprecated_4_2('TIME', arg, p_style);
        ELSE
            RETURN sys.babelfish_conv_string_to_time_deprecated_4_2('TIME', arg, p_style);
        END IF;
    END;
    $BODY$
    LANGUAGE plpgsql
    ...
    -- update body of babelfish_conv_string_to_datetime_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_conv_string_to_datetime_deprecated_4_2(IN p_datatype TEXT,
    ...
    BEGIN
        ...
        v_hours := coalesce(sys.babelfish_get_timeunit_from_string_deprecated_4_2(v_timepart, 'HOURS'), '0');
        v_minutes := coalesce(sys.babelfish_get_timeunit_from_string_deprecated_4_2(v_timepart, 'MINUTES'), '0');
        v_seconds := coalesce(sys.babelfish_get_timeunit_from_string_deprecated_4_2(v_timepart, 'SECONDS'), '0');
        v_fseconds := coalesce(sys.babelfish_get_timeunit_from_string_deprecated_4_2(v_timepart, 'FRACTSECONDS'), '0');
    ...
    ALTER FUNCTION sys.babelfish_try_conv_string_to_datetime(TEXT, TEXT, NUMERIC) RENAME TO babelfish_try_conv_string_to_datetime_deprecated_4_2;
    -- update body of babelfish_try_conv_string_to_datetime_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_try_conv_string_to_datetime_deprecated_4_2(IN p_datatype TEXT,
                                                                                    IN p_datetimestring TEXT,
                                                                                    IN p_style NUMERIC DEFAULT 0)
    RETURNS TIMESTAMP WITHOUT TIME ZONE
    AS
    $BODY$
    BEGIN
        RETURN sys.babelfish_conv_string_to_datetime_deprecated_4_2(p_datatype,
                                                                        p_datetimestring ,
                                                                        p_style);
    EXCEPTION
        WHEN OTHERS THEN
    ...
    -- update body of babelfish_conv_helper_to_datetime_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_conv_helper_to_datetime_deprecated_4_2(IN arg TEXT,
                                                                                IN try BOOL,
                                                                                IN p_style NUMERIC DEFAULT 0)
    ...
    BEGIN
        IF try THEN
            RETURN sys.babelfish_try_conv_string_to_datetime_deprecated_4_2('DATETIME', arg, p_style);
        ELSE
            RETURN sys.babelfish_conv_string_to_datetime_deprecated_4_2('DATETIME', arg, p_style);
        END IF;
    END;
    $BODY$
    LANGUAGE plpgsql
...
BEGIN
    ...
    -- update body of babelfish_conv_helper_to_date_1_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_conv_helper_to_date_1_deprecated_4_2(IN arg anyelement,
                                                                                IN try BOOL,
                                                                                IN p_style NUMERIC DEFAULT 0)
    RETURNS DATE
    AS
    ...
    BEGIN
        IF try THEN
            RETURN sys.babelfish_try_conv_to_date_deprecated_4_2(arg); 
        ELSE
...
BEGIN
    ...
    -- update body of babelfish_conv_helper_to_time_1_deprecated_4_2 such that it points to deprecated functions
    CREATE OR REPLACE FUNCTION sys.babelfish_conv_helper_to_time_1_deprecated_4_2(IN arg anyelement,
                                                                                IN try BOOL,
                                                                                IN p_style NUMERIC DEFAULT 0)
    RETURNS TIME
    AS
    ...
    BEGIN
        IF try THEN
            RETURN sys.babelfish_try_conv_to_time_deprecated_4_2(arg);
        ELSE
