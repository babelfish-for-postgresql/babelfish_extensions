...
-- Revoke execute privileges granted to public by default 
-- for functions and procedures created by current user
...
-- Reset original default privileges for function and procedures
