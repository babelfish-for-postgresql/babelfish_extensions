...
CREATE OR REPLACE FUNCTION sys.schema_id(IN schema_name sys.SYSNAME DEFAULT NULL::sys.SYSNAME)
RETURNS INT AS 'babelfishpg_tsql', 'schema_id' LANGUAGE C STABLE;
