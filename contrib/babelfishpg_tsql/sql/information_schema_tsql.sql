...
CREATE OR REPLACE VIEW information_schema_tsql.parameters
AS SELECT sys.db_name()::information_schema.sql_identifier AS specific_catalog,
    ...
    sys.db_name()::information_schema.sql_identifier AS udt_catalog,
    sys.schema_name(nt."oid")::information_schema.sql_identifier AS udt_schema,
  ...
  grant select on information_schema_tsql.parameters to public;