...
PG_KEYWORD("deallocate", K_DEALLOCATE)
...
PG_KEYWORD("fast_forward", K_FAST_FORWARD)
PG_KEYWORD("fetch", K_FETCH)
PG_KEYWORD("first", K_FIRST)
PG_KEYWORD("forward", K_FORWARD)
PG_KEYWORD("forward_only", K_FORWARD_ONLY)
PG_KEYWORD("get", K_GET)
PG_KEYWORD("global", K_GLOBAL)
...
PG_KEYWORD("is", K_IS)
PG_KEYWORD("keyset", K_KEYSET)
PG_KEYWORD("last", K_LAST)
PG_KEYWORD("local", K_LOCAL)
...
PG_KEYWORD("optimistic", K_OPTIMISTIC)
PG_KEYWORD("option", K_OPTION)
PG_KEYWORD("out", K_OUT)
PG_KEYWORD("output", K_OUTPUT)
...
PG_KEYWORD("raiserror", K_RAISERROR)
PG_KEYWORD("read_only", K_READ_ONLY)
