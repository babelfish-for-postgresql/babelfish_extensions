...
define_custom_variables(void)
{
	...
	DefineCustomBoolVariable("babelfishpg_tsql.enable_adhoc_antlr_parse_cache",
							 gettext_noop("Enables persistent caching of ANTLR parser results for ad-hoc TDS batch queries."),
							 gettext_noop("When enabled, repeated ad-hoc queries with the same normalized structure skip ANTLR re-parse."),
	...
	DefineCustomIntVariable("babelfishpg_tsql.adhoc_parse_cache_max_entries",
							gettext_noop("Maximum number of entries in the ad-hoc ANTLR parse cache table."),
							gettext_noop("When the cache exceeds this limit, the oldest 10%% of entries are evicted."),
	...
	DefineCustomBoolVariable("babelfishpg_tsql.validate_adhoc_antlr_parse_cache",
							 ...
							 gettext_noop("When enabled, cached ad-hoc parse trees are compared with fresh parse for correctness verification."),
