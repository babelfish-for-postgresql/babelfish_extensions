...
typedef enum PgTsqlInstrMetricType
{
	...
	INSTR_TSQL_SP_XML_PREPAREDOCUMENT,
	INSTR_TSQL_SP_XML_REMOVEDOCUMENT,
	...
	INSTR_UNSUPPORTED_TSQL_INLINE_INDEX,
	INSTR_UNSUPPORTED_TSQL_CREATE_FUNCTION_INLINE_OPTION,
