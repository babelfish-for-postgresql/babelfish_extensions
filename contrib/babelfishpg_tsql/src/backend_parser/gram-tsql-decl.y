...
%token <keyword> TSQL_ATAT TSQL_ALLOW_SNAPSHOT_ISOLATION
	...
	TSQL_TEXTIMAGE_ON TSQL_TZ TSQL_TZOFFSET TSQL_WEEK TSQL_WEEKDAY TSQL_WK TSQL_WW TSQL_YY TSQL_YYYY
	TSQL_SCHEMABINDING TSQL_IDENTITY_INSERT
	TSQL_EXEC TSQL_PROC TSQL_IIF TSQL_REPLICATION TSQL_PERSISTED
	...
	TSQL_WINDOWS CERTIFICATE DEFAULT_DATABASE DEFAULT_LANGUAGE HASHED
	MUST_CHANGE CHECK_EXPIRATION CHECK_POLICY CREDENTIAL SID OLD_PASSWORD
	UNLOCK TSQL_VALUES
