...
%type <str> datepart_arg datediff_arg datebucket_arg dateadd_arg tsql_untruncated_IDENT
...
%type <ival> tsql_opt_null_constraint
...
%token <keyword> TSQL_ATAT TSQL_ALLOW_SNAPSHOT_ISOLATION
	...
	TSQL_AUTO TSQL_EXPLICIT TSQL_RAW TSQL_PATH TSQL_FOR TSQL_BASE64 TSQL_ROOT TSQL_ELEMENTS TSQL_XSINIL TSQL_ABSENT TSQL_READPAST TSQL_XLOCK TSQL_NOEXPAND OPENJSON OPENXML JSON_MODIFY
	TSQL_JSON TSQL_INCLUDE_NULL_VALUES TSQL_WITHOUT_ARRAY_WRAPPER
	TSQL_MEMBER TSQL_SERVER TSQL_SPATIAL
