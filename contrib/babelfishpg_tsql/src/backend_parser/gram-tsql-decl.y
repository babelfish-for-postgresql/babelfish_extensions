...
%token <keyword> TSQL_ATAT TSQL_ALLOW_SNAPSHOT_ISOLATION TSQL_APPLY
	...
	TSQL_TEXTIMAGE_ON TSQL_TZ TSQL_TZOFFSET TSQL_W TSQL_WEEK TSQL_WEEKDAY TSQL_WK TSQL_WW TSQL_YY TSQL_YYYY
