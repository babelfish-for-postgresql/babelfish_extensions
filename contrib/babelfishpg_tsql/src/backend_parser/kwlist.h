/* there is deliberately not an #ifndef PGTSQL_KWLIST_H here */
...
PG_KEYWORD("absent", TSQL_ABSENT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("allow_snapshot_isolation", TSQL_ALLOW_SNAPSHOT_ISOLATION, UNRESERVED_KEYWORD)
...
PG_KEYWORD("apply", TSQL_APPLY, RESERVED_KEYWORD)
...
PG_KEYWORD("caller", TSQL_CALLER, UNRESERVED_KEYWORD)
...
PG_KEYWORD("certificate", TSQL_CERTIFICATE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("check_expiration", TSQL_CHECK_EXPIRATION, UNRESERVED_KEYWORD)
PG_KEYWORD("check_policy", TSQL_CHECK_POLICY, UNRESERVED_KEYWORD)
PG_KEYWORD("checkpoint", CHECKPOINT, UNRESERVED_KEYWORD)
PG_KEYWORD("choose", TSQL_CHOOSE, RESERVED_KEYWORD)
...
PG_KEYWORD("contains", TSQL_CONTAINS, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("credential", TSQL_CREDENTIAL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("date_bucket", TSQL_DATE_BUCKET, RESERVED_KEYWORD)
PG_KEYWORD("dateadd", TSQL_DATEADD, RESERVED_KEYWORD)
...
PG_KEYWORD("default_database", TSQL_DEFAULT_DATABASE, UNRESERVED_KEYWORD)
PG_KEYWORD("default_language", TSQL_DEFAULT_LANGUAGE, UNRESERVED_KEYWORD)
PG_KEYWORD("default_schema", TSQL_DEFAULT_SCHEMA, UNRESERVED_KEYWORD)
...
PG_KEYWORD("elements", TSQL_ELEMENTS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("exec", TSQL_EXEC, RESERVED_KEYWORD)
PG_KEYWORD("execute", EXECUTE, UNRESERVED_KEYWORD)
PG_KEYWORD("exists", EXISTS, COL_NAME_KEYWORD)
PG_KEYWORD("explain", EXPLAIN, UNRESERVED_KEYWORD)
PG_KEYWORD("explicit", TSQL_EXPLICIT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("hashed", TSQL_HASHED, UNRESERVED_KEYWORD)
...
PG_KEYWORD("identity_insert", TSQL_IDENTITY_INSERT, UNRESERVED_KEYWORD)
PG_KEYWORD("if", IF_P, UNRESERVED_KEYWORD)
PG_KEYWORD("iif", TSQL_IIF, RESERVED_KEYWORD)
...
PG_KEYWORD("include_null_values", TSQL_INCLUDE_NULL_VALUES, UNRESERVED_KEYWORD)
...
PG_KEYWORD("iso_week", TSQL_ISO_WEEK, UNRESERVED_KEYWORD)
PG_KEYWORD("isolation", ISOLATION, UNRESERVED_KEYWORD)
PG_KEYWORD("isowk", TSQL_ISOWK, UNRESERVED_KEYWORD)
PG_KEYWORD("isoww", TSQL_ISOWW, UNRESERVED_KEYWORD)
PG_KEYWORD("join", JOIN, TYPE_FUNC_NAME_KEYWORD)
PG_KEYWORD("json", TSQL_JSON, UNRESERVED_KEYWORD)
PG_KEYWORD("json_modify", JSON_MODIFY, COL_NAME_KEYWORD)
...
PG_KEYWORD("log", TSQL_LOG, RESERVED_KEYWORD)
PG_KEYWORD("log10", TSQL_LOG10, RESERVED_KEYWORD)
PG_KEYWORD("logged", LOGGED, UNRESERVED_KEYWORD)
PG_KEYWORD("login", TSQL_LOGIN, UNRESERVED_KEYWORD)
...
PG_KEYWORD("member", TSQL_MEMBER, UNRESERVED_KEYWORD)
PG_KEYWORD("merge", MERGE, UNRESERVED_KEYWORD)
PG_KEYWORD("merge_action", MERGE_ACTION, COL_NAME_KEYWORD)
...
PG_KEYWORD("must_change", TSQL_MUST_CHANGE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("nocheck", TSQL_NOCHECK, UNRESERVED_KEYWORD)
...
PG_KEYWORD("nvarchar", TSQL_NVARCHAR, COL_NAME_KEYWORD)
...
PG_KEYWORD("old_password", TSQL_OLD_PASSWORD, UNRESERVED_KEYWORD)
...
PG_KEYWORD("output", TSQL_OUTPUT, RESERVED_KEYWORD)
...
PG_KEYWORD("parse", TSQL_PARSE, RESERVED_KEYWORD)
PG_KEYWORD("parser", PARSER, UNRESERVED_KEYWORD)
PG_KEYWORD("partial", PARTIAL, UNRESERVED_KEYWORD)
PG_KEYWORD("partition", PARTITION, UNRESERVED_KEYWORD)
PG_KEYWORD("passing", PASSING, UNRESERVED_KEYWORD)
PG_KEYWORD("password", PASSWORD, UNRESERVED_KEYWORD)
PG_KEYWORD("path", TSQL_PATH, UNRESERVED_KEYWORD)
PG_KEYWORD("percent", TSQL_PERCENT, RESERVED_KEYWORD)
PG_KEYWORD("persisted", TSQL_PERSISTED, UNRESERVED_KEYWORD)
PG_KEYWORD("pivot", TSQL_PIVOT, RESERVED_KEYWORD)
...
PG_KEYWORD("raw", TSQL_RAW, UNRESERVED_KEYWORD)
PG_KEYWORD("read", READ, UNRESERVED_KEYWORD)
PG_KEYWORD("readcommitted", TSQL_READCOMMITTED, UNRESERVED_KEYWORD)
PG_KEYWORD("readonly", TSQL_READONLY, RESERVED_KEYWORD)
...
PG_KEYWORD("recompile", TSQL_RECOMPILE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("replication", TSQL_REPLICATION, UNRESERVED_KEYWORD)
...
PG_KEYWORD("sid", TSQL_SID, UNRESERVED_KEYWORD)
...
PG_KEYWORD("spatial", TSQL_SPATIAL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("substring", TSQL_SUBSTRING, UNRESERVED_KEYWORD)
...
PG_KEYWORD("top", TSQL_TOP, RESERVED_KEYWORD)
PG_KEYWORD("trailing", TRAILING, RESERVED_KEYWORD)
PG_KEYWORD("tran", TSQL_TRAN, UNRESERVED_KEYWORD)
...
PG_KEYWORD("try_parse", TSQL_TRY_PARSE, RESERVED_KEYWORD)
PG_KEYWORD("type", TYPE_P, UNRESERVED_KEYWORD)
PG_KEYWORD("types", TYPES_P, UNRESERVED_KEYWORD)
PG_KEYWORD("tz", TSQL_TZ, UNRESERVED_KEYWORD)
PG_KEYWORD("tzoffset", TSQL_TZOFFSET, UNRESERVED_KEYWORD)
...
PG_KEYWORD("unlock", TSQL_UNLOCK, UNRESERVED_KEYWORD)
PG_KEYWORD("unlogged", UNLOGGED, UNRESERVED_KEYWORD)
PG_KEYWORD("unpivot", TSQL_UNPIVOT, RESERVED_KEYWORD)
...
PG_KEYWORD("windows", TSQL_WINDOWS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("without_array_wrapper", TSQL_WITHOUT_ARRAY_WRAPPER, UNRESERVED_KEYWORD)
...
PG_KEYWORD("xsinil", TSQL_XSINIL, UNRESERVED_KEYWORD)
