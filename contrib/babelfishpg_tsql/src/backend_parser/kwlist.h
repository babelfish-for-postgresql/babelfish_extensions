...
PG_KEYWORD("certificate", CERTIFICATE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("check_expiration", CHECK_EXPIRATION, UNRESERVED_KEYWORD)
PG_KEYWORD("check_policy", CHECK_POLICY, UNRESERVED_KEYWORD)
...
PG_KEYWORD("credential", CREDENTIAL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("default_database", DEFAULT_DATABASE, UNRESERVED_KEYWORD)
PG_KEYWORD("default_language", DEFAULT_LANGUAGE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("hashed", HASHED, UNRESERVED_KEYWORD)
...
PG_KEYWORD("must_change", MUST_CHANGE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("old_password", OLD_PASSWORD, UNRESERVED_KEYWORD)
...
PG_KEYWORD("sid", SID, UNRESERVED_KEYWORD)
