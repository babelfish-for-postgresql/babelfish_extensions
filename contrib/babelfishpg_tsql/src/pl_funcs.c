...
pltsql_free_function_memory(PLtsql_function *func)
{
    ...
    /* free exec codes
     * It is called before free_block because exec_code shares same nodes with the tree.
     * Shared nodes will be skipped and only nodes generated by codegen will be freed.
     */
