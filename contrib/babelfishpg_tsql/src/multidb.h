...
/* helper functions */
extern const char *get_dbo_schema_name_by_mode(const char *dbname, MigrationMode mode);
extern const char *get_db_datareader_name(const char *dbname);
extern const char *get_db_datawriter_name(const char *dbname);
extern const char *get_db_datareader_name_by_mode(const char *dbname, MigrationMode mode);
extern const char *get_db_datawriter_name_by_mode(const char *dbname, MigrationMode mode);
