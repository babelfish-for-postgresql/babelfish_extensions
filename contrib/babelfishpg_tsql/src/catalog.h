...
extern char *get_authid_user_ext_physical_name_user_enabled(const char *db_name, const char *login, bool user_enabled);
...
extern char *get_user_for_database_for_set_user(const char *db_name, bool set_user);
