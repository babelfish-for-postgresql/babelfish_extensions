 ...
 *   1. Session GUC `enable_routine_parse_cache` OR per-function antlr_cache_enabled flag is on
 ...
 *   out_cache_enabled  - output: whether antlr_cache_enabled column is true for this function
