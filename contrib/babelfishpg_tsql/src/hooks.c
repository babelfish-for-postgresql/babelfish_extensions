 ...
 * 			Collation Hooks
 *****************************************/
static bool pltsql_strpos_non_determinstic(text *t1, text *t2, Oid collid, int *r);
static bool pltsql_replace_non_determinstic(text *t1, text *t2, text *t3, Oid collid, text **result);
