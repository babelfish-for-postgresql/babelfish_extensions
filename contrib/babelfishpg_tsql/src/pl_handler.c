				...
				if (sql_dialect == SQL_DIALECT_TSQL)
				{
					...
					*/
					...
					PG_TRY();
					{
						...
						pltsql_store_func_default_positions(address, cfs->parameters, queryString, origname_location, with_recompile, alter_location);
