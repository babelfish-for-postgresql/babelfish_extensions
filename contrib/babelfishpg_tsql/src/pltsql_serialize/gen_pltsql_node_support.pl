...
foreach my $n (@node_types)
{
	...
	print $nth "#define T_${n} ((NodeTag) $tagno)\n";
	$last_tag = $n;
	$tagno++;
}
...
{
	my $expected_no = $tagno - 1;  # last assigned number
