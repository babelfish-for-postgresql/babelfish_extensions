...
extern void check_db_access(const char* dn_name);
extern void set_db_user_and_path(const char* db_name);
extern void set_search_path(const char* db_name, const char* user);
