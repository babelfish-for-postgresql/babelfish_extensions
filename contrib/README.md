...
3. run cleanup.sh, init.sh and mvn test
      ...
      mvn test
      ```
For detailed instructions on how to write, add, and run tests in JDBC test framework, refer [here](https://github.com/babelfish-for-postgresql/babelfish_extensions/blob/BABEL_1_X_DEV/test/JDBC/README.md).
