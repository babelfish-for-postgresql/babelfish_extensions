...
Steps on how to get PostGIS working on open-source:
    ```
    wget http://postgis.net/stuff/postgis-3.5.1.tar.gz
    tar -xvzf postgis-3.5.1.tar.gz
    sudo yum install https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm
    sudo yum install gdal gdal-devel
    sudo yum install https://www.rpmfind.net/linux/epel/8/Everything/x86_64/Packages/g/geos-3.13.1-1.el8.x86_64.rpm
    sudo yum install https://www.rpmfind.net/linux/epel/8/Everything/x86_64/Packages/g/geos-devel-3.13.1-1.el8.x86_64.rpm
    wget https://download.osgeo.org/proj/proj-9.5.0.tar.gz
    tar -xvzf proj-9.5.0.tar.gz
    cd proj-9.5.0
    mkdir build
    cd build
