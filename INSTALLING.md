...
export BABELFISH_HOME=/opt/babelfish/2.2.0
...
```sh
sudo mkdir -p /var/lib/babelfish/2.2.0
...
sudo su - postgres
export BABELFISH_HOME=/opt/babelfish/2.2.0
export BABELFISH_DATA=/var/lib/babelfish/2.2.0/data
```
...
PostgreSQL 14.5 Babelfish for PostgreSQL on x86_64-pc-linux-gnu
(1 row affected)
```
