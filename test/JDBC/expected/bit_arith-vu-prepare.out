...
CREATE VIEW bitbigintdiv_vu AS SELECT CAST(1 AS sys.BIT) / CAST(1 as BIGINT) AS A, CAST(0 AS sys.BIT) / CAST(1 AS BIGINT) AS B, CAST(0 AS sys.BIT) / CAST(0 as BIGINT) AS C;
GO
