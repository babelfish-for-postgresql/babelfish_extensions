...
~~ERROR (Message: new row for relation "babel_5179_t1" violates check constraint "timecmpbabel_5179_t1c6223dd410d6d5a24f8e283c57ae03de")~~
...
create table babel_5179_t2(col1 varchar(50), col2 as cast(col1 as time), constraint timecmp check(col1 >= '12:45:37.1'));
go
...
~~ERROR (Message: new row for relation "babel_5179_t2" violates check constraint "timecmpbabel_5179_t2c6223dd410d6d5a24f8e283c57ae03de")~~


create view babel_5179_v22 as select col1, col2 from babel_5179_t2;
go

create function babel_5179_f2() returns table 
as return (
