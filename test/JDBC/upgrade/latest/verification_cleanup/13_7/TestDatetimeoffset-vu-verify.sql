select * from testdatetimeoffset_vu_prepare_t1;
go

-- Test comparision with datetime/smalldatetime/date
select * from testdatetimeoffset_vu_prepare_t1 where df >= '2020-03-15 00:00:00';
go
select * from testdatetimeoffset_vu_prepare_t1 where df >= '2020-03-15 09:00:00 +7';
go
select * from testdatetimeoffset_vu_prepare_t1 where df >= '2020-03-15 09:00:00 +8' 
                    and df < '2020-03-15 09:00:00';
go
select * from testdatetimeoffset_vu_prepare_t1 where df < '1992-05-24';
go

-- Test datetimeoffset default value
select a from testdatetimeoffset_vu_prepare_t2 where b = 1;
go
