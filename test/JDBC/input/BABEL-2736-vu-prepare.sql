...
CREATE VIEW BABEL_BINARY_vu_prepare_v25 AS 
SELECT CONVERT(BINARY(5), CAST('1234' AS NVARCHAR(10)), 2)
UNION ALL
SELECT CONVERT(BINARY(5), CAST(12345 AS DECIMAL(10,2)), 0)
UNION ALL
SELECT CONVERT(BINARY(5), LOWER('0xABCD'), 1)
GO
