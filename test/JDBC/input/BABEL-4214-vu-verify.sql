...
SELECT FLOOR(CAST(CAST('1900-01-10 11:00:50.675' AS DATETIME) AS FLOAT));
GO

SELECT FLOOR(CAST(CAST('1900-01-10 11:00:50.675' AS DATETIME) AS FLOAT)) +.999999;
GO

SELECT CAST(FLOOR(CAST(CAST('1900-01-10 11:00:50.675' AS DATETIME) AS FLOAT)) AS DATETIME);
GO
