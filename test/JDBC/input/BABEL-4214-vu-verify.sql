...
SELECT CONVERT(BIT, ISNULL(CAST('1900-01-10 11:00:50.675' AS DATETIME), 0));
GO

SELECT CAST(CAST('1900-01-10 11:00:50.675' AS DATETIME) AS FLOAT);
GO

SELECT CAST(CAST('1900-01-10 11:00:50.675' AS DATETIME) AS FLOAT) +.999999;
GO

SELECT CAST(CAST(CAST('1900-01-10 11:00:50.675' AS DATETIME) AS FLOAT) AS DATETIME);
GO
...
SELECT CAST(CAST('1910-01-10 12:56:50.675' AS DATETIME) AS SMALLINT);
GO
...
SELECT CAST(CAST(CAST('1900-01-10 12:56:50.675' AS DATETIME) AS sql_variant) AS TINYINT);
GO

SELECT CAST(CAST(CAST('1910-01-10 12:56:50.675' AS DATETIME) AS sql_variant) AS SMALLINT);
GO
...
SELECT CAST(CAST('1890-12-21 12:56:50.675' AS DATETIME) AS SMALLINT);
GO
...
SELECT CONVERT(BIT, ISNULL(CAST('1900-01-10 11:00:50.675' AS SMALLDATETIME), 0));
GO

SELECT CAST(CAST('1900-01-10 11:00:50.675' AS SMALLDATETIME) AS FLOAT);
GO

SELECT CAST(CAST('1900-01-10 11:00:50.675' AS SMALLDATETIME) AS FLOAT) +.999999;
GO

SELECT CAST(CAST(CAST('1900-01-10 11:00:50.675' AS SMALLDATETIME) AS FLOAT) AS SMALLDATETIME);
GO
...
SELECT CAST(CAST('1900-01-10 12:56:50.675' AS SMALLDATETIME) AS SMALLINT);
GO
...
SELECT CAST(CAST('1910-01-10 12:56:50.675' AS SMALLDATETIME) AS SMALLINT);
GO
...
SELECT CAST(CAST(CAST('1900-01-01 12:56:50.675' AS SMALLDATETIME) AS sql_variant) AS TINYINT);
GO

SELECT CAST(CAST(CAST('1910-01-01 12:56:50.675' AS SMALLDATETIME) AS sql_variant) AS SMALLINT);
GO
