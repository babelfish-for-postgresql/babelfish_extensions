...
SELECT CAST(CAST(CAST('1900-01-01 11:00:50.675' AS DATETIME) AS sql_variant) AS TINYINT);
GO
...
SELECT CAST(CAST(CAST('2023-01-01 12:56:50.675' AS DATETIME) AS sql_variant) AS DECIMAL);
GO
...
SELECT CAST(CAST(CAST('2023-01-01 12:56:50.675' AS SMALLDATETIME) AS sql_variant) AS DECIMAL);
GO
