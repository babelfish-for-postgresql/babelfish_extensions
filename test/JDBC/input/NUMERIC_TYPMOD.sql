...
-- LEN
SELECT LEN('Hello World') * 1.00;
GO

-- UNICODE
SELECT UNICODE('Á') * 1.00;
GO
...
-- SCOPE_IDENTITY
CREATE TABLE TestTable (ID INT IDENTITY(1,1), Value VARCHAR(50));
INSERT INTO TestTable (Value) VALUES ('Test');
SELECT SCOPE_IDENTITY() * 1.00;
GO
...
-- ABS
SELECT ABS(-123.45) * 1.00;
GO

SELECT ABS(123.45) * 1.00;
GO

SELECT ABS(1.2) * CAST(2 AS DECIMAL(5,2));
GO

SELECT ABS(1.2) * CAST(2 AS DECIMAL(10,4));
GO
...
SELECT SIGN(1.2) * CAST(2 AS DECIMAL(5,2));
GO

SELECT SIGN(1.2) * CAST(2 AS DECIMAL(10,4));
GO

-- POWER
SELECT POWER(2, 3) * 1.00;
GO

SELECT POWER(4.5, 2) * 1.00;
GO

SELECT POWER(1.2, 2) * CAST(1 AS DECIMAL(5,2));
GO

SELECT POWER(1.2, 2) * CAST(1 AS DECIMAL(10,4));
GO
...
-- CEILING
SELECT CEILING(123.45) * 1.00;
GO

SELECT CEILING(-123.45) * 1.00;
GO

SELECT CEILING(-123.456789) * CAST(1.23 AS DECIMAL(5,2));
GO

SELECT CEILING(-123.456789) * CAST(1.2345 AS DECIMAL(10,4));
GO

SELECT CEILING(1.2) * CAST(1 AS DECIMAL(5,2));
GO

SELECT CEILING(1.2) * CAST(1 AS DECIMAL(10,4));
GO

-- FLOOR
SELECT FLOOR(123.45) * 1.00;
GO

SELECT FLOOR(-123.45) * 1.00;
GO

SELECT FLOOR(12.456789) * CAST(2 AS DECIMAL(5,2));
GO

SELECT FLOOR(123.456789) * CAST(2 AS DECIMAL(10,4));
GO

SELECT FLOOR(1.2) * CAST(2 AS DECIMAL(5,2));
GO

SELECT FLOOR(1.2) * CAST(2 AS DECIMAL(10,4));
GO

-- DEGREES
SELECT DEGREES(1) * 1.00;
GO

SELECT DEGREES(1) * 1.00;
GO

SELECT DEGREES(1.2) * CAST(1.2 AS DECIMAL(5,2));
GO

SELECT DEGREES(1.34) * CAST(1.2 AS DECIMAL(10,4));
GO

-- RADIANS
SELECT RADIANS(180) * 1.00;
GO

SELECT RADIANS(360) * 1.00;
GO

SELECT RADIANS(1.2) * CAST(1.2 AS DECIMAL(5,2));
GO

SELECT RADIANS(1.34) * CAST(1.2 AS DECIMAL(10,4));
GO

-- String Related
SELECT (ASCII('A') + LEN('Hello')) * 1.00;
GO

CREATE TABLE TestIdentity (ID INT IDENTITY(1,1), Value VARCHAR(50));
GO

SELECT IDENT_SEED('TestIdentity') * 1.00;
GO

SELECT IDENT_INCR('TestIdentity') * 1.00;
GO

INSERT INTO TestIdentity (Value) VALUES ('Test');
GO

SELECT IDENT_CURRENT('TestIdentity') * 1.00;
GO
