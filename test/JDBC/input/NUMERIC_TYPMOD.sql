...
CREATE TABLE BABEL_5879 (
    id INT PRIMARY KEY,
    value NUMERIC(10,2)
);

INSERT INTO BABEL_5879 (id, value) VALUES (1, 1234.56), (2, 7890.12);
GO
...
WHERE TABLE_NAME LIKE 'BABEL_5879_t1'
...
SELECT 
    ...
    NUMERIC_SCALE
FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME LIKE 'BABEL_5879_t2'
ORDER BY COLUMN_NAME;
GO

DROP TABLE BABEL_5879_t1;
GO

DROP TABLE BABEL_5879_t2;
GO

DROP TABLE BABEL_5879;
GO
