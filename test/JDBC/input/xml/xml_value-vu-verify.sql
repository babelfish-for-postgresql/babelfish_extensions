...
select xml::XmlColumn.value('/', 'varchar') from babel_5223_xml_value_t3
go

select geometry::GeomColumn.STAsText() from babel_5223_xml_value_t3
go

select geography::GeogColumn.STAsText() from babel_5223_xml_value_t3
go

select XmlColumn::xml.value('/', 'varchar') from babel_5223_xml_value_t3
go

select GeomColumn::geometry.STAsText() from babel_5223_xml_value_t3
go

select GeogColumn::geography.STAsText() from babel_5223_xml_value_t3
go
...
select babel_5223_xml_value_xmlUDT::NonExistentMethod()
go

select babel_5223_geometryUDT::STGeomFromText('POINT (1 2)', 0)
go

select babel_5223_geographyUDT::STGeomFromText('POINT (1 2)', 4326)
go
