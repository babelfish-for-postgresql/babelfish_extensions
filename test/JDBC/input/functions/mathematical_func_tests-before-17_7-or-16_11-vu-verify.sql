...
SELECT SQRT(decimal_val) FROM sqrt_exact_numeric_tests WHERE id != 8;
GO
SELECT SQRT(decimal_val) FROM sqrt_exact_numeric_tests WHERE id = 8;
GO

SELECT SQRT(bigint_val) FROM sqrt_exact_numeric_tests WHERE id != 8;
GO
SELECT SQRT(bigint_val) FROM sqrt_exact_numeric_tests WHERE id = 8;
GO

SELECT SQRT(int_val) FROM sqrt_exact_numeric_tests WHERE id != 8;
GO
SELECT SQRT(int_val) FROM sqrt_exact_numeric_tests WHERE id = 8;
GO

SELECT SQRT(smallint_val) FROM sqrt_exact_numeric_tests WHERE id != 8;
GO
SELECT SQRT(smallint_val) FROM sqrt_exact_numeric_tests WHERE id = 8;
GO

SELECT SQRT(tinyint_val) FROM sqrt_exact_numeric_tests WHERE id != 8;
GO
SELECT SQRT(tinyint_val) FROM sqrt_exact_numeric_tests WHERE id = 8;
GO

SELECT SQRT(money_val) FROM sqrt_exact_numeric_tests WHERE id != 8;
GO
SELECT SQRT(money_val) FROM sqrt_exact_numeric_tests WHERE id = 8;
GO

SELECT SQRT(smallmoney_val) FROM sqrt_exact_numeric_tests WHERE id != 8;
GO
SELECT SQRT(smallmoney_val) FROM sqrt_exact_numeric_tests WHERE id = 8;
GO

SELECT SQRT(bit_val) FROM sqrt_exact_numeric_tests WHERE id != 8;
GO
SELECT SQRT(bit_val) FROM sqrt_exact_numeric_tests WHERE id = 8;
GO
...
SELECT SQRT(real_val) FROM sqrt_approximate_numeric_tests WHERE id != 8;
GO
SELECT SQRT(real_val) FROM sqrt_approximate_numeric_tests WHERE id = 8;
GO

SELECT SQRT(char_val) FROM sqrt_char_tests WHERE id != 4;
GO
SELECT SQRT(char_val) FROM sqrt_char_tests WHERE id = 4;
GO
...
SELECT SQRT(nchar_val) FROM sqrt_unicode_tests WHERE id != 4;
GO
SELECT SQRT(nchar_val) FROM sqrt_unicode_tests WHERE id = 4;
GO
