...
SELECT DATEDIFF_BIG(weekday, '2002-12-31 23:59:59.999', '2006-01-01 00:00:00.000');
GO

SELECT DATEDIFF_BIG(dw, '2003-12-31 23:59:59.999', '2006-01-01 00:00:00.000');
GO

SELECT DATEDIFF_BIG(w, '2004-12-31 23:59:59.999', '2006-01-01 00:00:00.000');
GO
