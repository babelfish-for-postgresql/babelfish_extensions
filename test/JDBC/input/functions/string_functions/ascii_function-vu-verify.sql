...
-- Test date formats
DECLARE @date DATETIME = '2025-09-19 06:07:36.520'
SELECT ASCII(CONVERT(VARCHAR, @date, 101)) AS USDate,
       ASCII(CONVERT(VARCHAR, @date, 103)) AS BritishDate,
       ASCII(CONVERT(VARCHAR, @date, 120)) AS ISODate;
GO
...
DECLARE @date DATETIME = '2025-09-19 06:07:36.520'
SELECT ASCII(CAST(DATEPART(YEAR, @date) AS VARCHAR)) AS YearASCII,
       ASCII(CAST(DATEPART(MONTH, @date) AS VARCHAR)) AS MonthASCII,
       ASCII(CAST(DATEPART(DAY, @date) AS VARCHAR)) AS DayASCII;
GO
