...
SELECT '|' + LTRIM(a) + '|' FROM babel_4489_ltrim_t3
GO

SELECT '|' + LTRIM(a) COLLATE CHINESE_PRC_CI_AS + '|' FROM babel_4489_ltrim_t3
GO
...
-- dependent objects
SELECT * FROM babel_4489_ltrim_view
GO

EXEC babel_4489_ltrim_proc
GO

SELECT * FROM babel_4489_ltrim_func()
GO
