...
CREATE VIEW babel_3409_concat_dep_view1 AS
    SELECT CONCAT(col_varchar, col_int, col_varbinary, col_text) AS concatenated_column FROM babel_3409_concat_t1
GO

CREATE PROCEDURE babel_3409_concat_dep_proc1 AS
    SELECT CONCAT(col_varchar, col_int, col_varbinary, col_text) FROM babel_3409_concat_t1 ORDER BY id
GO
