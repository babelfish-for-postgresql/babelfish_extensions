...
DECLARE @TMP_CHAR CHAR = NULL;
SELECT CONVERT(DATETIME, @TMP_CHAR)
GO

DECLARE @TMP_NCHAR NCHAR = NULL;
SELECT CONVERT(DATETIME, @TMP_NCHAR)
GO

DECLARE @TMP_VARCHAR VARCHAR = NULL;
SELECT CONVERT(DATETIME, @TMP_VARCHAR)
GO

DECLARE @TMP_NVARCHAR NVARCHAR = NULL;
SELECT CONVERT(DATETIME, @TMP_NVARCHAR)
GO
