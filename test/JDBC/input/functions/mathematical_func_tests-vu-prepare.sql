...
INSERT INTO BABEL_5672_sqrt_exact_numeric_table                                                    -- Overflow values
VALUES 
(9, 99999999999999999999999999999999999999.99, 99999999999999999999999999999999999999.99, 
    9223372036854775808, 2147483648, 32768, 256, 
    922337203685477.5808, 214748.3648, NULL)
GO
...
INSERT INTO BABEL_5672_sqrt_approximate_numeric_table                                              -- Overflow values
VALUES 
(9, 1.79E+309, 3.41E+38)
GO

INSERT INTO BABEL_5672_sqrt_approximate_numeric_table                                              -- Underflow values
VALUES 
(10, 2.22507E-308, 1.17549E-38)
GO
...
INSERT INTO BABEL_5672_sqrt_char_table                                                             -- Overflow values
VALUES 
(6, '1.79E+309', '1.79E+309')
GO
...
INSERT INTO BABEL_5672_sqrt_unicode_table                                                          -- Overflow values
VALUES 
(6, N'1.79E+309', N'1.79E+309')
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_numeric_overflow1 AS SELECT SQRT(99999999999999999999999999999999999999.99);
GO
CREATE VIEW BABEL_5672_sqrt_numeric_overflow2 AS SELECT SQRT(CAST(99999999999999999999999999999999999999.99 AS NUMERIC(38,2)));
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_decimal_overflow1 AS SELECT SQRT(CAST(99999999999999999999999999999999999999.99 AS DECIMAL(38,2)));
GO
CREATE VIEW BABEL_5672_sqrt_decimal_overflow2 AS SELECT SQRT(CAST(99999999999999999999999999999999999999.99 AS DECIMAL));
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_int_overflow AS SELECT SQRT(2147483648);
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_bigint_overflow AS SELECT SQRT(9223372036854775808);
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_smallint_overflow AS SELECT SQRT(32768);
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_tinyint_overflow AS SELECT SQRT(256);
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_float_overflow AS SELECT SQRT(1.79E+309);
GO
CREATE VIEW BABEL_5672_sqrt_float_underflow AS SELECT SQRT(2.22E-308);
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_real_overflow AS SELECT SQRT(3.41E+38);
GO
CREATE VIEW BABEL_5672_sqrt_real_underflow AS SELECT SQRT(1.17E-38);
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_money_overflow AS SELECT SQRT(CAST(922337203685477.5808 AS MONEY));
GO
...
GO
CREATE VIEW BABEL_5672_sqrt_smallmoney_overflow AS SELECT SQRT(CAST(214748.3648 AS SMALLMONEY));
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(12.25 AS NUMERIC(12,2))));
END
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(0 AS NUMERIC(12,2))));
END
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(NULL AS NUMERIC(12,2))));
END
GO

CREATE FUNCTION BABEL_5672_sqrt_test_numeric_overflow()
RETURNS FLOAT
AS
BEGIN
    RETURN (SELECT SQRT(CAST(99999999999999999999999999999999999999.99 AS NUMERIC(38,2))));
END
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(12.25 AS DECIMAL(12,2))));
END
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(0 AS DECIMAL(12,2))));
END
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(NULL AS DECIMAL(12,2))));
END
GO

CREATE FUNCTION BABEL_5672_sqrt_test_decimal_overflow()
RETURNS FLOAT
AS
BEGIN
    RETURN (SELECT SQRT(CAST(99999999999999999999999999999999999999.99 AS DECIMAL(38,2))));
END
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(1 AS BIT)));
END
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(0 AS BIT)));
END
GO
...
AS
BEGIN
    RETURN (SELECT SQRT(CAST(NULL AS BIT)));
END
GO
...
CREATE PROCEDURE BABEL_5672_sqrt_test_numeric_overflow_proc
AS
...
CREATE PROCEDURE BABEL_5672_sqrt_test_decimal_overflow_proc
AS
SELECT SQRT(CAST(99999999999999999999999999999999999999.99 AS DECIMAL(38,2)));
GO
