...
GO
SELECT dbo.test_timezone_offset('E. Australia Standard Time', '+10:00', '+10:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Kamchatka Standard Time', '+12:00', '+12:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Greenwich Standard Time', '+00:00', '+00:00') AS test_result_utc;
GO
...
GO
SELECT dbo.test_timezone_offset('Belarus Standard Time', '+03:00', '+03:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Turks And Caicos Standard Time', '-04:00', '-05:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Central America Standard Time', '-06:00', '-06:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Greenland Standard Time', '-01:00', '-02:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Aleutian Standard Time', '-09:00', '-10:00') AS test_result_atc;
GO
...
GO
SELECT dbo.test_timezone_offset('Syria Standard Time', '+03:00', '+03:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Easter Island Standard Time', '-05:00', '-06:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('SA Western Standard Time', '-04:00', '-04:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Tocantins Standard Time', '-03:00', '-03:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Norfolk Standard Time', '+12:00', '+11:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Paraguay Standard Time', '-03:00', '-03:00') AS test_result_utc;
GO
SELECT dbo.test_timezone_offset('Mid-Atlantic Standard Time', '-02:00', '-02:00') AS test_result_utc;
GO
