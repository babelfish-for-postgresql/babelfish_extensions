...
SELECT CASE 2
   WHEN 1 THEN CAST(1.23 AS NUMERIC(20,2))
   WHEN 2 THEN CAST(GETDATE() AS DATE)
   WHEN 3 THEN CAST(GETDATE() AS TIME)
   WHEN 4 THEN CAST(SYSDATETIME() AS DATETIME2(7))
   WHEN 5 THEN CAST(SYSDATETIMEOFFSET() AS DATETIMEOFFSET)
   WHEN 6 THEN CAST(GETDATE() AS SMALLDATETIME)
END AS Result
GO
