...
CREATE PROCEDURE BABEL_3802_vu_prepare_t_p11 AS SELECT power(CAST(2147483648 AS INT),1)
GO

CREATE PROCEDURE BABEL_3802_vu_prepare_t_p12 AS SELECT power(CAST(-2147483649 AS INT),1)
GO

CREATE PROCEDURE BABEL_3802_vu_prepare_t_p13 AS SELECT power(CAST(2147483647 AS INT),2)
GO
...
CREATE PROCEDURE BABEL_3802_vu_prepare_t_p14 AS SELECT power(CAST(32768 AS SMALLINT),1)
GO

CREATE PROCEDURE BABEL_3802_vu_prepare_t_p15 AS SELECT power(CAST(32767 AS SMALLINT),4)
GO

CREATE PROCEDURE BABEL_3802_vu_prepare_t_p16 AS SELECT power(CAST(-32769 AS SMALLINT),1)
GO

---Trigger TinyInt Error

CREATE PROCEDURE BABEL_3802_vu_prepare_t_p17 AS SELECT power(CAST(-1 AS TINYINT),1)
GO

CREATE PROCEDURE BABEL_3802_vu_prepare_t_p18 AS SELECT power(CAST(255 AS TINYINT),5)
GO

CREATE PROCEDURE BABEL_3802_vu_prepare_t_p19 AS SELECT power(CAST(256 AS TINYINT),1)
GO
...
--Trigger Int Error
CREATE VIEW BABEL_3802_vu_prepare_t_v10 AS ( SELECT power(CAST(-2147483648 AS INT),2) AS res1);
GO

CREATE VIEW BABEL_3802_vu_prepare_t_v11 AS ( SELECT power(CAST(2147483648 AS INT),1) AS res1);
GO

CREATE VIEW BABEL_3802_vu_prepare_t_v12 AS ( SELECT power(CAST(-2147483649 AS INT),1) AS res1);
GO

CREATE VIEW BABEL_3802_vu_prepare_t_v13 AS ( SELECT power(CAST(2147483647 AS INT),2) AS res1);
GO

--Trigger Small Int Error
CREATE VIEW BABEL_3802_vu_prepare_t_v14 AS ( SELECT power(CAST(-32768 AS SMALLINT),3) AS res1);
GO

CREATE VIEW BABEL_3802_vu_prepare_t_v15 AS ( SELECT power(CAST(32768 AS SMALLINT),1) AS res1);
GO

CREATE VIEW BABEL_3802_vu_prepare_t_v16 AS ( SELECT power(CAST(32767 AS SMALLINT),4) AS res1);
GO

CREATE VIEW BABEL_3802_vu_prepare_t_v17 AS ( SELECT power(CAST(-32769 AS SMALLINT),1) AS res1);
GO

--Trigger Tiny Int Error
CREATE VIEW BABEL_3802_vu_prepare_t_v18 AS ( SELECT power(CAST(-1 AS TINYINT),1) AS res1);
GO

CREATE VIEW BABEL_3802_vu_prepare_t_v19 AS ( SELECT power(CAST(255 AS TINYINT),5) AS res1);
GO

CREATE VIEW BABEL_3802_vu_prepare_t_v20 AS ( SELECT power(CAST(256 AS TINYINT),1) AS res1);
GO