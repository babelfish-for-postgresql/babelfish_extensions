...
INSERT INTO BABEL_3802_vu_prepare_t_1 VALUES (NULL, NULL, NULL, NULL, NULL);
GO
INSERT INTO BABEL_3802_vu_prepare_t_1 VALUES (2147483647, 1.0, 9223372036854, 32767, 255);
GO
INSERT INTO BABEL_3802_vu_prepare_t_1 VALUES (-2147483648, 1,-9223372036854775808, -32768, 0);
GO
INSERT INTO BABEL_3802_vu_prepare_t_1 VALUES (101.23, 1.0, 97777.32, 376.466, 120.32);
GO
...
CREATE PROCEDURE BABEL_3802_vu_prepare_t_p8 AS SELECT power(CAST(1 AS TINYINT),1.1)
GO
...
CREATE VIEW BABEL_3802_vu_prepare_t_v3 AS (
    SELECT
        ...
        power(CAST(8962 AS SMALLINT),1.2) AS res6
    );
GO
