...
VALUES ('exact match'), ('EXACT MATCH'), ('Exact Match'),
       ...
       ('a'), ('A'), ('ab'), ('abc'), ('ABC'),
       ('100%done'), ('under_score'),
       ('back\slash'), ('single''quote'),
       ('   spaces   '), ('trailing   '), ('   leading'),
       ('aaaaaaaaaa'), ('AAAAAAAAAA'), ('aAbBcCdDeE');
GO
...
VALUES (N'exact match'), (N'EXACT MATCH'), (N'Exact Match'),
       ...
       (N'prefix_def'), (N'prefix_ghi'),
       (N'something else'), (N'another value'),
       (N'test data 1'), (N'test data 2'), (N'test data 3'),
       (N'café'), (N'CAFÉ'),
       (N'résumé'), (N'RÉSUMÉ'), (N'resume'), (N'RESUME'),
       (N'naïve'), (N'NAÏVE'), (N'naive'), (N'NAIVE'),
       (N'straße'), (N'STRASSE'),
       (N'a'), (N'A'), (N'ab'), (N'abc'), (N'ABC'),
       (N'100%done'), (N'under_score'),
       (N'back\slash'), (N'single''quote'),
       (N'   spaces   '), (N'trailing   '), (N'   leading'),
       (N'aaaaaaaaaa'), (N'AAAAAAAAAA'), (N'aAbBcCdDeE');
GO
...
-- Views (using CI_AS explicit collation tables)

CREATE VIEW BABEL_5966_vw_like_exact AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'exact match';
GO

CREATE VIEW BABEL_5966_vw_like_prefix AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'prefix%';
GO

CREATE VIEW BABEL_5966_vw_like_suffix AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'%match';
GO

CREATE VIEW BABEL_5966_vw_like_contains AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'%data%';
GO

CREATE VIEW BABEL_5966_vw_like_single_char AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'_';
GO

CREATE VIEW BABEL_5966_vw_not_like AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col NOT LIKE N'zzz%';
GO

CREATE VIEW BABEL_5966_vw_not_like_exact AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col NOT LIKE N'exact match';
GO

CREATE VIEW BABEL_5966_vw_like_nvar_exact AS
SELECT Id, Col FROM BABEL_5966_TestLikeNVarCollation_CI_AS WHERE Col LIKE N'exact match';
GO

CREATE VIEW BABEL_5966_vw_like_nvar_prefix AS
SELECT Id, Col FROM BABEL_5966_TestLikeNVarCollation_CI_AS WHERE Col LIKE N'prefix%';
GO

CREATE VIEW BABEL_5966_vw_like_nvar_suffix AS
SELECT Id, Col FROM BABEL_5966_TestLikeNVarCollation_CI_AS WHERE Col LIKE N'%match';
GO

CREATE VIEW BABEL_5966_vw_like_char_exact AS
SELECT Id, Col FROM BABEL_5966_TestLikeCharCollation_CI_AS WHERE Col LIKE N'exact match';
GO

CREATE VIEW BABEL_5966_vw_like_char_prefix AS
SELECT Id, Col FROM BABEL_5966_TestLikeCharCollation_CI_AS WHERE Col LIKE N'prefix%';
GO

CREATE VIEW BABEL_5966_vw_like_char_suffix AS
SELECT Id, Col FROM BABEL_5966_TestLikeCharCollation_CI_AS WHERE Col LIKE N'%match';
GO

CREATE VIEW BABEL_5966_vw_like_or AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS
WHERE Col LIKE N'prefix%' OR Col LIKE N'test%';
GO

CREATE VIEW BABEL_5966_vw_like_and AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS
WHERE Col LIKE N'prefix%' AND Col LIKE N'%abc';
GO

CREATE VIEW BABEL_5966_vw_like_escape_pct AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'100!%done' ESCAPE '!';
GO

CREATE VIEW BABEL_5966_vw_like_escape_underscore AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'under!_score' ESCAPE '!';
GO

CREATE VIEW BABEL_5966_vw_like_unicode AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'café';
GO

CREATE VIEW BABEL_5966_vw_like_unicode_prefix AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'caf%';
GO

CREATE VIEW BABEL_5966_vw_like_cast_varchar AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE CAST(N'exact match' AS VARCHAR(50));
GO

CREATE VIEW BABEL_5966_vw_like_cast_nvarchar AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE CAST(N'prefix%' AS NVARCHAR(50));
GO

CREATE VIEW BABEL_5966_vw_like_cast_char AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE CAST('exact match' AS CHAR(20));
GO
...
SELECT * FROM BABEL_5966_vw_like_prefix WHERE Col LIKE N'prefix_a%';
GO

CREATE VIEW BABEL_5966_vw_like_with_id AS
SELECT Id, Col FROM BABEL_5966_TestLikeCollation_CI_AS
WHERE Col LIKE N'prefix%' AND Id > 0;
GO
...
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'exact match';
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_prefix_const AS
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'prefix%';
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_suffix_const AS
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE N'%match';
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_varchar_param @pattern VARCHAR(50) AS
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @pattern;
END;
GO
...
CREATE PROCEDURE BABEL_5966_sp_like_all_types @pattern NVARCHAR(50) AS
BEGIN
    SELECT COUNT(*) AS varchar_cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @pattern;
    SELECT COUNT(*) AS nvarchar_cnt FROM BABEL_5966_TestLikeNVarCollation_CI_AS WHERE Col LIKE @pattern;
    SELECT COUNT(*) AS char_cnt FROM BABEL_5966_TestLikeCharCollation_CI_AS WHERE Col LIKE @pattern;
END;
GO

CREATE PROCEDURE BABEL_5966_sp_not_like_param @pattern NVARCHAR(50) AS
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col NOT LIKE @pattern;
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_escape @pattern NVARCHAR(50), @esc CHAR(1) AS
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @pattern ESCAPE @esc;
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_dynamic @prefix VARCHAR(50) AS
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @prefix + '%';
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_output @pattern NVARCHAR(50), @cnt INT OUTPUT AS
BEGIN
    SELECT @cnt = COUNT(*) FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @pattern;
END;
GO
...
BEGIN
    SELECT COUNT(*) AS cast_varchar FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE CAST(@val AS VARCHAR(50));
    SELECT COUNT(*) AS cast_nvarchar FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE CAST(@val AS NVARCHAR(50));
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_multi_condition @p1 NVARCHAR(50), @p2 NVARCHAR(50) AS
BEGIN
    SELECT COUNT(*) AS and_cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @p1 AND Col LIKE @p2;
    SELECT COUNT(*) AS or_cnt FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @p1 OR Col LIKE @p2;
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_subquery @pattern NVARCHAR(50) AS
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS
    WHERE Id IN (SELECT Id FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @pattern);
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_exists @pattern NVARCHAR(50) AS
BEGIN
    SELECT COUNT(*) AS cnt FROM BABEL_5966_TestLikeCollation_CI_AS t1
    WHERE EXISTS (SELECT 1 FROM BABEL_5966_TestLikeCollation_CI_AS t2 WHERE t2.Col LIKE @pattern AND t2.Id = t1.Id);
END;
GO

CREATE PROCEDURE BABEL_5966_sp_like_top @pattern NVARCHAR(50), @top INT AS
BEGIN
    SELECT TOP(@top) Col FROM BABEL_5966_TestLikeCollation_CI_AS WHERE Col LIKE @pattern ORDER BY Col;
END;
GO
