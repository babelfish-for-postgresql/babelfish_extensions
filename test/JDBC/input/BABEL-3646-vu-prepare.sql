...
CREATE VIEW BABEL_3646_vu_prepare_v21 as (SELECT TRY_CAST(TRY_CAST (TRY_CONVERT(XML, '1990-01-01') as text) as date));
GO
CREATE PROCEDURE BABEL_3646_vu_prepare_p21 as (SELECT TRY_CAST(TRY_CAST (TRY_CONVERT(XML, '1990-01-01') as text) as date));
GO
CREATE FUNCTION BABEL_3646_vu_prepare_f21()
RETURNS DATE AS
BEGIN
...
CREATE VIEW BABEL_3646_vu_prepare_v23 as (SELECT TRY_CAST(TRY_CONVERT(DATETIME, CAST('1990-01-01' AS DATE)) AS TIME));
GO
CREATE PROCEDURE BABEL_3646_vu_prepare_p23 as (SELECT TRY_CAST(TRY_CONVERT(DATETIME, CAST('1990-01-01' AS DATE)) AS TIME));
GO
CREATE FUNCTION BABEL_3646_vu_prepare_f23()
RETURNS TIME AS
BEGIN
