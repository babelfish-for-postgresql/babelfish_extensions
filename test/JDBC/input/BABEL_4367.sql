...
SELECT name FROM sys.views WHERE name in ('BABEL_4367_TYPE_1', 'BABEL_4367_TYPE_2') ORDER BY name ASC
GO
...
DROP PROCEDURE IF EXISTS BABEL_4367_PROCEDURE_1, BABEL_4367_3
GO
...
DROP PROCEDURE IF EXISTS BABEL_4367_PROCEDURE_1, BABEL_4367_PROCEDURE_2
GO
DROP TYPE IF EXISTS BABEL_4367_TYPE_1
GO
DROP VIEW IF EXISTS BABEL_4367_VIEW_1, BABEL_4367_VIEW_2, BABEL_4367_VIEW_3, BABEL_4367_VIEW_4, BABEL_4367_VIEW_5
GO
DROP TABLE IF EXISTS BABEL_4367_1, BABEL_4367_2, BABEL_4367_3
GO
