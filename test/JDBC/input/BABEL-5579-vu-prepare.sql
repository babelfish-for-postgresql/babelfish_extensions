...
go
CREATE VIEW TestGeospatialMethods_SRIDFromGeom AS SELECT PointColumn.STSrid AS SRID FROM TestGeospatialMethods_YourTableTemp;
go
CREATE VIEW TestGeospatialMethods_SRIDFromGeog AS SELECT  location.STSrid AS Dimension FROM TestGeospatialMethods_SPATIALPOINTGEOG_dttemp ORDER BY location.Lat;
go