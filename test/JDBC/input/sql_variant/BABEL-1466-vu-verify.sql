...
alter table t1_babel_1466 add b as convert(smallint, 1) persisted;
GO
...
alter table t1_babel_1466 add c as convert(varchar(2), 1) persisted;
GO

-- CONVERT from sql_variant to other types are volatile and can not be used to generate computed column
alter table t1_babel_1466 add d as convert(smallint, convert(sql_variant, 1)) persisted;
GO

-- CONVERT from datetime/datetime2/smalldatetime to string type is volatile and can not be used to generate computed column
alter table t1_babel_1466 add d as convert(varchar(15), convert(datetime, '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(char(15), convert(datetime, '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(varchar(15), convert(datetime2, '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(char(15), convert(datetime2, '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(varchar(15), convert(smalldatetime, '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(char(15), convert(smalldatetime, '01-01-2012')) persisted;
GO

-- CONVERT from datetime column to string type is volatile and can not be used to generate computed column
alter table t1_babel_1466 add d as convert(varchar(15), t) persisted;
GO

-- CONVERT from string type to datetime/datetime2/smalldatetime is volatile and can not be used to generate computed column
alter table t1_babel_1466 add d as convert(datetime, convert(varchar(15), '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(datetime, convert(char(15), '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(datetime2, convert(varchar(15), '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(datetime2, convert(char(15), '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(smalldatetime, convert(varchar(15), '01-01-2012')) persisted;
GO

alter table t1_babel_1466 add d as convert(smalldatetime, convert(char(15), '01-01-2012')) persisted;
GO
