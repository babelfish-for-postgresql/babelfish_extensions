select
    pg_catalog.concat('[', c5nn, ']') as c5nn_concat,
    '[' + c5nn +']' as c5nn_to_text_concat,
    pg_catalog.concat('[', cast(c5nn as varchar), ']') as c5nn_to_varchar_concat,
    pg_catalog.concat('[', c5n, ']') as c5n_concat,
    '[' + c5n + ']' as c5n_to_text_concat,
    pg_catalog.concat('[', cast(c5n as varchar), ']') as c5n_to_varchar_concat,
