...
SELECT set_config('babelfishpg_tsql.force_antlr_parse_cache', 'off', false);
GO

SELECT sys.antlr_parse_cache_stats();
GO
--- Simple SP_PREPARE
DECLARE @handle int;
...
SELECT set_config('babelfishpg_tsql.force_antlr_parse_cache', 'on', false);
GO
