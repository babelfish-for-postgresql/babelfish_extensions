...
-- CAST
DECLARE @ABC VARBINARY(50) = 0x48656C6C6F2C20576F726C6421;
SELECT CAST(@ABC AS VARCHAR(50));
SELECT CAST(@ABC AS NVARCHAR(50));
go
 
DECLARE @ABC VARBINARY(50) = 0x480065006C006C006F002C00200057006F0072006C0064002100;
SELECT CAST(@ABC AS VARCHAR(50));
go
DECLARE @ABC VARBINARY(50) = 0x480065006C006C006F002C00200057006F0072006C0064002100;
SELECT CAST(@ABC AS NVARCHAR(50));
...
-- CONVERT
DECLARE @ABC VARBINARY(50) = 0x48656C6C6F2C20576F726C6421;
SELECT CONVERT(VARCHAR(50), @ABC);
SELECT CONVERT(NVARCHAR(50), @ABC);
go
...
-- TRY CAST
DECLARE @ABC VARBINARY(50) = 0x48656C6C6F2C20576F726C6421;
SELECT TRY_CAST(@ABC AS VARCHAR(50));
SELECT TRY_CAST(@ABC AS NVARCHAR(50));
go
...
-- TRY CONVERT
DECLARE @ABC VARBINARY(50) = 0x48656C6C6F2C20576F726C6421;
SELECT TRY_CONVERT(VARCHAR(50), @ABC);
SELECT TRY_CONVERT(NVARCHAR(50), @ABC);
go
