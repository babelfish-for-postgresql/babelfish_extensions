-- 14.6 (aka extension version 2.4.0) has a major change to how FOR JSON
...
CREATE TABLE forjson_14_6_vu_t_countries (
[Id] INT,
[Age] INT,
[Country] VARCHAR(25))
GO

INSERT INTO forjson_14_6_vu_t_countries values
(1,25, 'India'),
(2,40, 'USA'),
(3,30, 'India'),
(4,20, NULL),
...
create table forjson_vu_t1 (x int)
insert into forjson_vu_t1 values (1)
go
...
WITH forjson_vu_with1(avg_age) AS (
	SELECT avg(Age)
	FROM forjson_14_6_vu_t_countries
)
SELECT (
	SELECT Id, Age, Country
	FROM forjson_14_6_vu_t_countries, forjson_vu_with1
...
SELECT (
	SELECT Id, Age, Country 
	FROM forjson_14_6_vu_t_countries, forjson_vu_with2
