...
GO
SELECT CAST(922337203685477.5807 AS MONEY) + CAST(1 AS BIT);
GO
SELECT CAST(1 AS MONEY) + CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1 AS SMALLMONEY) + CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1 AS TINYINT) + CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1 AS SMALLINT) + CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1 AS INT) + CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1 AS BIGINT) + CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1 AS BIT) + CAST(922337203685477.5807 AS MONEY);
GO
...
GO
SELECT CAST(-922337203685477.5808 AS MONEY) - CAST(1 AS BIT);
GO
SELECT CAST(1 AS BIGINT) - CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(1 AS MONEY) - CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(1 AS SMALLMONEY) - CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(1 AS TINYINT) - CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(1 AS SMALLINT) - CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(1 AS INT) - CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(1 AS BIGINT) - CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(1 AS BIT) - CAST(-922337203685477.5808 AS MONEY);
GO
...
SELECT CAST(-922337203685477.5808 AS MONEY) + CAST(1 AS BIT);
GO
SELECT CAST(-922337203685477.5808 AS MONEY) + CAST(0 AS BIT);
GO
SELECT CAST(1 AS BIGINT) + CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(1 AS MONEY) + CAST(-922337203685477.5808 AS MONEY);
...
SELECT CAST(1 AS BIT) + CAST(-922337203685477.5808 AS MONEY);
GO
SELECT CAST(0 AS BIT) + CAST(-922337203685477.5808 AS MONEY);
GO
...
SELECT CAST(922337203685477.5807 AS MONEY) * CAST(1 AS BIT);
GO
SELECT CAST(922337203685477.5807 AS MONEY) * CAST(0 AS BIT);
GO
SELECT CAST(922337203685477.5807 AS MONEY) * CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1.1 AS MONEY) * CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1.1 AS SMALLMONEY) * CAST(922337203685477.5807 AS MONEY);;
GO
SELECT CAST(2 AS TINYINT) * CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(2 AS SMALLINT) * CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(2 AS INT) * CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(2 AS BIGINT) * CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(0 AS BIT) * CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1 AS BIT) * CAST(922337203685477.5807 AS MONEY);
GO
...
SELECT CAST(922337203685477.5807 AS MONEY) / CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(922337203685477.5807 AS MONEY) / CAST(2 AS BIT);
GO
SELECT CAST(922337203685477.5807 AS MONEY) / CAST(500 AS BIT);
GO
SELECT CAST(922337203685477.5807 AS MONEY) / CAST(0 AS BIT);
GO
SELECT CAST(1.1 AS MONEY) / CAST(922337203685477.5807 AS MONEY);
...
SELECT CAST(2 AS BIGINT) / CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(2 AS BIT) / CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(1 AS BIT) / CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(500 AS BIT) / CAST(922337203685477.5807 AS MONEY);
GO
SELECT CAST(0 AS BIT) / CAST(922337203685477.5807 AS MONEY);
GO
...
GO
SELECT CAST(1 AS SMALLMONEY) + CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1 AS TINYINT) + CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1 AS SMALLINT) + CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1 AS INT) + CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1 AS BIGINT) + CAST(214748.3647 AS SMALLMONEY);
GO
...
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) - CAST(0 AS BIT);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) - CAST(1 AS BIT);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) - CAST(214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS SMALLMONEY) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS TINYINT) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS SMALLINT) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS INT) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS BIGINT) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS BIT) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(0 AS BIT) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(214748.3648 AS SMALLMONEY) - CAST(-214748.3648 AS SMALLMONEY);
GO
...
GO
SELECT CAST(1 AS MONEY) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS REAL) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS FLOAT) - CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) + CAST(1 AS SMALLMONEY);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) + CAST(1 AS TINYINT);
...
GO
SELECT CAST(1.1 AS SMALLMONEY) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1.1 AS TINYINT) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1.1 AS SMALLINT) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1.1 AS INT) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1 AS BIT) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(0 AS BIT) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(500 AS BIT) * CAST(214748.3647 AS SMALLMONEY);
GO
...
GO
SELECT CAST(1.1 AS MONEY) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1.1 AS REAL) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(1.1 AS FLOAT) * CAST(214748.3647 AS SMALLMONEY);
GO
SELECT CAST(-214748.3647 AS SMALLMONEY) * CAST(1.1 AS MONEY);
GO
SELECT CAST(-214748.3647 AS SMALLMONEY) * CAST(1.1 AS REAL);
...
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(214749 AS BIGINT);
GO
SELECT CAST(214748.3648 AS SMALLMONEY) / CAST(0.9 AS SMALLMONEY);
GO
SELECT CAST(214748.3648 AS SMALLMONEY) / CAST(214749 AS BIGINT);
...
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(2 AS BIGINT);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(1 AS TINYINT);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(60 AS SMALLINT);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(43 AS INT);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(10000 AS BIGINT);
GO
SELECT CAST(0.9 AS SMALLMONEY) / CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(2 AS BIGINT) / CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(1 AS TINYINT) / CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(60 AS SMALLINT) / CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(43 AS INT) / CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(10000 AS BIGINT) / CAST(-214748.3648 AS SMALLMONEY);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(214748 AS BIGINT);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(1 AS BIT);
GO
SELECT CAST(-214748.3648 AS SMALLMONEY) / CAST(214748 AS BIT);
GO
SELECT CAST(214748.3648 AS SMALLMONEY) / CAST(0.9 AS MONEY);
GO
SELECT CAST(214748.3648 AS SMALLMONEY) / CAST(0.9 AS REAL);
...
-- =============================================
SELECT CASE 2 
WHEN 1 THEN CAST(5.5 as DECIMAL(10,2)) 
ELSE CAST(214748.3647 as SMALLMONEY) * CAST(1.0001 as SMALLMONEY) 
END
GO
SELECT CASE 2 
WHEN 1 THEN CAST(5.5 as DECIMAL(10,2)) 
ELSE CAST(922337203685477.5807 as MONEY) * CAST(1.0001 as MONEY) 
END
GO
SELECT CASE 2 
WHEN 1 THEN CAST(5.5 as DECIMAL(10,2)) 
ELSE CAST(214748.3647 as SMALLMONEY) + CAST(214748.3647 as SMALLMONEY)
END
GO
SELECT CASE 2 
WHEN 1 THEN CAST(5.5 as DECIMAL(10,2)) 
ELSE CAST(214748.3647 as SMALLMONEY) / CAST(0.5 as SMALLMONEY)
END
GO
SELECT CASE 2 
WHEN 1 THEN CAST(5.5 as DECIMAL(10,2)) 
ELSE CAST(-214748.3647 as SMALLMONEY) * CAST(1.001 as SMALLMONEY)
END
GO
...
--           Result Does NOT Overflow
-- =============================================
-- FIXME: handled in PR - 3719
SELECT CASE 2 
WHEN 1 THEN CAST(5.5 as DECIMAL(10,2)) 
ELSE CAST(214748.3647 as MONEY) * CAST(1.0001 as MONEY) 
END
GO
SELECT CASE 2 
WHEN 1 THEN CAST(5.5 as DECIMAL(10,2)) 
ELSE CAST(214748.3647 as SMALLMONEY) + CAST(214748.3647 as MONEY)
END
GO
SELECT CASE 2 
WHEN 1 THEN CAST(5.5 as DECIMAL(10,2)) 
ELSE CAST(214748.3647 as SMALLMONEY) / CAST(0.5 as MONEY)
END
GO
...
-- BIT + MONEY
SELECT CAST(1 AS BIT) + CAST(123.45 AS MONEY) AS result;
GO

-- BIT + MONEY
SELECT CAST(0 AS BIT) + CAST(123.45 AS MONEY) AS result;
GO

-- BIT + MONEY
SELECT CAST(-32 AS BIT) + CAST(123.45 AS MONEY) AS result;
GO
...
-- MONEY % REAL
-- FIXME: To be fixed in BABEL-5746
SELECT CAST(123.45 AS MONEY) % CAST(678.90 AS REAL) AS result;
GO
...
------------------------------------------------------------------------
---- 3. Mathematical Functions Tests
------------------------------------------------------------------------
...
SELECT CAST(CAST('123.45' AS VARCHAR(40)) AS MONEY) AS [VARCHAR_POS_TO_MONEY],
       ...
       CAST(CAST('$123.45' AS VARCHAR(40)) AS MONEY) AS [VARCHAR_CURRENCY_TO_MONEY],
       CAST(CAST('1,234.56' AS VARCHAR(40)) AS MONEY) AS [VARCHAR_COMMA_TO_MONEY];
GO
...
SELECT CAST(CAST('214748.3647' AS VARCHAR(40)) AS SMALLMONEY) AS [VARCHAR_POS_TO_SMALLMONEY],
       ...
       CAST(CAST('$123.45' AS VARCHAR(40)) AS SMALLMONEY) AS [VARCHAR_CURRENCY_TO_SMALLMONEY],
       CAST(CAST('1,234.56' AS VARCHAR(40)) AS SMALLMONEY) AS [VARCHAR_COMMA_TO_SMALLMONEY];
GO
...
SELECT CAST(CAST(N'123.45' AS NCHAR(40)) AS MONEY) AS [NCHAR_POS_TO_MONEY],
       ...
       CAST(CAST(N'$123.45' AS NCHAR(40)) AS MONEY) AS [NCHAR_CURRENCY_TO_MONEY],
       CAST(CAST(N'1,234.56' AS NCHAR(40)) AS MONEY) AS [NCHAR_COMMA_TO_MONEY];
GO
...
SELECT CAST(CAST(N'214748.3647' AS NCHAR(40)) AS SMALLMONEY) AS [NCHAR_POS_TO_SMALLMONEY],
       ...
       CAST(CAST(N'$123.45' AS NCHAR(40)) AS SMALLMONEY) AS [NCHAR_CURRENCY_TO_SMALLMONEY],
       CAST(CAST(N'1,234.56' AS NCHAR(40)) AS SMALLMONEY) AS [NCHAR_COMMA_TO_SMALLMONEY];
GO
...
SELECT CAST(CAST(N'123.45' AS NVARCHAR(40)) AS MONEY) AS [NVARCHAR_POS_TO_MONEY],
       ...
       CAST(CAST(N'$123.45' AS NVARCHAR(40)) AS MONEY) AS [NVARCHAR_CURRENCY_TO_MONEY],
       CAST(CAST(N'1,234.56' AS NVARCHAR(40)) AS MONEY) AS [NVARCHAR_COMMA_TO_MONEY];
GO
