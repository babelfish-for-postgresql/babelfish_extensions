...
CREATE TABLE t1 (a NUMERIC(38, 10), b NUMERIC(38, 37));
GO

INSERT INTO t1 VALUES (1.1234567890, 1.1234567890);
GO

INSERT INTO t1 VALUES (8.8765434567, 8.1234634);
GO

INSERT INTO t1 VALUES (9.5678, 1);
GO
...
SELECT COUNT_BIG(NULL) / 1 FROM t1
GO
...
CREATE TABLE t1 (a numeric_18_2, b numeric_7_2);
GO
