...
create database db_2924_1 ON PRIMARY (NAME = 'X') COLLATE BBF_Unicode_CP1_CI_AI;
go
drop database db_2924_1;
go

create database db_2924_2 ON PRIMARY (NAME = 'X') LOG ON (NAME = 'Y') COLLATE BBF_Unicode_CP1_CI_AI;
go
drop database db_2924_2;
go

create database db_2924_3 ON PRIMARY (NAME = 'X'), (NAME = 'X2') LOG ON (NAME = 'Y'), (NAME = 'Y2') COLLATE BBF_Unicode_CP1_CI_AI;
go
drop database db_2924_3;
go

create database db_2924_4 ON PRIMARY (NAME = 'X'), FILEGROUP W (NAME='W1'), (NAME='W2'), (NAME = 'X2') LOG ON FILEGROUP Z (NAME = 'Z1'), (NAME = 'Z2'), (NAME = 'Y'), (NAME = 'Y2') COLLATE BBF_Unicode_CP1_CI_AI;
drop database db_2924_4;
go

create database db_2924_5 CONTAINMENT = NONE ON PRIMARY (NAME = 'X'), FILEGROUP W (NAME='W1'), (NAME='W2'), (NAME = 'X2') LOG ON FILEGROUP Z (NAME = 'Z1'), (NAME = 'Z2'), (NAME = 'Y'), (NAME = 'Y2') COLLATE BBF_Unicode_CP1_CI_AI WITH DB_CHAINING ON, PERSISTENT_LOG_BUFFER = ON (DIRECTORY_NAME = '/tmp');
drop database db_2924_5;
go
