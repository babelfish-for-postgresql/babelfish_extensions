-- test case 1 for json string with length > 4000 (the previous default limit) 
DECLARE @jsonInventory NVARCHAR(Max)
...
-- test case 2
DECLARE @jsonProduction NVARCHAR(Max)
...
-- test case 3
DECLARE @jsonHealthcare NVARCHAR(Max)
