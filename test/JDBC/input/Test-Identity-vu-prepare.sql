...
INSERT test_identity_vu_prepare_t2 values ('Nirmit'),('Sumit'),('Sharu')
GO

CREATE PROCEDURE test_identity_vu_prepare_p2
AS
INSERT INTO test_identity_vu_prepare_t2 VALUES ('Nirmit_Shah')
...
AS
INSERT INTO test_identity_vu_prepare_t3 VALUES ('Nirmit_Shah')
...
INSERT test_identity_vu_prepare_t3 values ('Shah'),('Jaiswal'),('Goel')
GO
...
FOR INSERT AS   
   BEGIN  
   INSERT test_identity_vu_prepare_t3  VALUES ('IT')  
   END;
GO

INSERT INTO test_identity_vu_prepare_t2 values('Raj')
GO
...
INSERT test_identity_vu_prepare_t4 values ('Shah',21),('Jaiswal',20),('Goel',23)
GO
...
INSERT test_identity_vu_prepare_t5 values ('Shah',21),('Jaiswal',20),('Goel',23)
GO
