...
-- integral
CREATE VIEW babel_3556_vu_prepare_v3 AS
SELECT CAST(922337203685478 AS fixeddecimal);
GO

CREATE VIEW babel_3556_vu_prepare_v4 AS
SELECT CAST(-922337203685478 AS fixeddecimal);
GO

CREATE VIEW babel_3556_vu_prepare_v5 AS
...
-- decimal
CREATE VIEW babel_3556_vu_prepare_v6 AS
SELECT CAST($922337203685478.5807 AS money);
GO

CREATE VIEW babel_3556_vu_prepare_v7 AS
...
GO
-- integral
CREATE VIEW babel_3556_vu_prepare_v8 AS
SELECT CAST($922337203685478 AS money);
GO

CREATE VIEW babel_3556_vu_prepare_v9 AS
SELECT CAST($-922337203685478 AS money);
GO

CREATE VIEW babel_3556_vu_prepare_v10 AS
...
-- decimal
CREATE VIEW babel_3556_vu_prepare_v11 AS
SELECT CAST($214748.3648 AS smallmoney);
GO

CREATE VIEW babel_3556_vu_prepare_v12 AS
...
-- integer
CREATE VIEW babel_3556_vu_prepare_v13 AS
SELECT CAST($214749 AS smallmoney);
GO

CREATE VIEW babel_3556_vu_prepare_v14 AS
SELECT CAST($-214749 AS smallmoney);
GO

CREATE VIEW babel_3556_vu_prepare_v15 AS
SELECT CAST($1232422322334223423121 AS smallmoney);
GO

CREATE VIEW babel_3556_vu_prepare_v16 AS
SELECT CAST($-1232422322334223423121 AS smallmoney);
GO
...
-- cast inside view
CREATE VIEW babel_3556_vu_prepare_v17 AS
    SELECT CAST(CAST(1234 as bigint) as money);
GO

CREATE VIEW babel_3556_vu_prepare_v18 AS
...
CREATE PROCEDURE  babel_3556_vu_prepare_p1 (@val fixeddecimal) AS
SELECT @val AS val
GO

CREATE PROCEDURE  babel_3556_vu_prepare_p2 (@val money) AS
SELECT @val AS val
GO

CREATE PROCEDURE  babel_3556_vu_prepare_p3 (@val smallmoney) AS
SELECT @val AS val
GO

CREATE PROCEDURE  babel_3556_vu_prepare_p4 (@in bigint, @out fixeddecimal OUTPUT) AS
set @out = @in
GO

CREATE PROCEDURE  babel_3556_vu_prepare_p5 (@in bigint, @out smallmoney OUTPUT) AS
set @out = @in
GO

CREATE PROCEDURE  babel_3556_vu_prepare_p6 (@in bigint, @out money OUTPUT) AS
set @out = @in
GO


-- function
CREATE FUNCTION babel_3556_vu_prepare_f1(@val fixeddecimal) 
RETURNS table AS
RETURN SELECT @val 
GO

CREATE FUNCTION babel_3556_vu_prepare_f2(@val money)  
RETURNS table AS
RETURN
SELECT @val 
GO

CREATE FUNCTION babel_3556_vu_prepare_f3(@val smallmoney) 
RETURNS table  AS
RETURN SELECT @val 
GO

CREATE FUNCTION babel_3556_vu_prepare_f4(@val bigint)
...
CREATE FUNCTION babel_3556_vu_prepare_f5(@val bigint)
RETURNS money AS
BEGIN
RETURN @val;
END
...
CREATE FUNCTION babel_3556_vu_prepare_f6(@val bigint)
