...
go
-- test 3 : subquery
SELECT val1 FROM (SELECT COL2_T2 + COL3_T2 AS val1 FROM BABEL_5454_T2) a
go
...
-- (38,5) * (10, 7)
SELECT COL6_T12 * COL4_T12 AS RESULT FROM (SELECT * FROM BABEL_5454_T11 UNION ALL SELECT * FROM BABEL_5454_T11) a ORDER BY RESULT
GO

-- (38,6) / (38,6)
SELECT COL2_T12 / COL2_T12 AS Result FROM (SELECT * FROM BABEL_5454_T11 UNION ALL SELECT * FROM BABEL_5454_T11) a ORDER BY RESULT
GO
