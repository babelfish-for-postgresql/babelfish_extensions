...
-- ============================================
-- SECTION 22: INSERT..EXEC with procedures
-- ============================================

INSERT INTO forxml_path_elements_results (xml_data)
EXEC forxml_path_elements_p_insert;
GO

SELECT * FROM forxml_path_elements_results;
GO

TRUNCATE TABLE forxml_path_elements_results;
GO

INSERT INTO forxml_path_elements_results (xml_data)
EXEC forxml_path_elements_p_insert_xsinil;
GO
...
-- ============================================
-- SECTION 23: SELECT INTO variable
-- ============================================
...
-- ============================================
-- SECTION 24: SELECT...INTO (create new table)
-- ============================================
...
-- ============================================
-- SECTION 25: Regular view with FOR XML
-- ============================================
...
-- ============================================
-- SECTION 26: Dependent Views (using FOR XML PATH, ELEMENTS)
-- ============================================
...
-- ============================================
-- SECTION 27: Dependent Functions (using FOR XML PATH, ELEMENTS)
-- ============================================
...
-- ============================================
-- SECTION 28: XML methods on FOR XML result
-- ============================================
