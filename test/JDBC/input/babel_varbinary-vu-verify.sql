...
-- Test Case 16: depedent objects
-- Select from table
SELECT * FROM babel_varbinary_test_table;
GO
...
SELECT 
    t1.fixedlen_col as t1_fixed_value,
    t1.maxlen_col as t1_max_value,
    t2.fixedlen_col as t2_fixed_value,
    t2.maxlen_col as t2_max_value,
...
ORDER BY t1_fixed_value, t1_max_value, t2_fixed_value, t2_max_value, 
         max_fixed_addition, fixed_fixed_addition, max_max_addition;
GO
