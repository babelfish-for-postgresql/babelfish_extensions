...
DROP TABLE IF EXISTS test_where;
GO
...
DROP TABLE IF EXISTS test_col_assign;
GO
...
DROP TABLE IF EXISTS test_str_complex;
GO
...
DROP TABLE IF EXISTS test_mixed_types;
GO
...
DROP TABLE IF EXISTS test_running_max;
GO

DROP TABLE IF EXISTS test_cross_db;
GO
...
DROP TABLE IF EXISTS test_large_string;
GO

DROP TABLE IF EXISTS test_complex_expr;
GO
...
DROP FUNCTION IF EXISTS custom_function
GO