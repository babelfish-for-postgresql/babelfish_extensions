...
-- Geometry to char/varchar
SELECT id, CAST(geom AS char(100)) AS geom_char, CAST(geom AS varchar(100)) AS geom_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS char) AS geom_char, CAST(geom AS varchar) AS geom_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS varchar(MAX)) AS geom_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS char(14)) AS geom_char, CAST(geom AS varchar(14)) AS geom_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS varchar(1)) AS geom_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS char(1)) AS geom_char FROM geo_cast_test ORDER BY id;
GO

-- Geography to char/varchar
SELECT id, CAST(geog AS char(100)) AS geog_char, CAST(geog AS varchar(100)) AS geog_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS char) AS geog_char, CAST(geog AS varchar) AS geog_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS varchar(MAX)) AS geog_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS char(14)) AS geog_char, CAST(geog AS varchar(14)) AS geog_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS varchar(1)) AS geog_varchar FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS char(1)) AS geog_char FROM geo_cast_test ORDER BY id;
GO

-- Geometry to binary/varbinary
SELECT id, CAST(geom AS binary(100)) AS geom_binary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS varbinary(100)) AS geom_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS binary) AS geom_binary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS varbinary) AS geom_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS varbinary(MAX)) AS geom_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS binary(38)) AS geom_binary, CAST(geom AS varbinary(38)) AS geom_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS binary(1)) AS geom_binary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geom AS varbinary(1)) AS geom_varbinary FROM geo_cast_test ORDER BY id;
GO

-- Geography to binary/varbinary
SELECT id, CAST(geog AS varbinary(100)) AS geog_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS binary(100)) AS geog_binary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS varbinary) AS geog_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS binary) AS geog_binary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS varbinary(MAX)) AS geog_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS binary(38)) AS geog_binary, CAST(geog AS varbinary(38)) AS geog_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS varbinary(1)) AS geog_varbinary FROM geo_cast_test ORDER BY id;
GO

SELECT id, CAST(geog AS binary(1)) AS geog_binary FROM geo_cast_test ORDER BY id;
GO

select cast(geometry::STPointFromText(cast(N'Point(1 1 1 1)' as varbinary(max)), 4326) as varchar(max))
GO

select cast(geography::STPointFromText(cast(N'Point(1 1 1 1)' as varbinary(max)), 4326) as varchar(max))
GO

select cast(geometry::STGeomFromText(cast(N'Point(1 1 1 1)' as varbinary(max)), 4326) as varchar(max))
GO
