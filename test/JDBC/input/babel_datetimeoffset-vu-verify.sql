...
-- Query the view in different ways

-- Get all results
SELECT * FROM DateTypeTestDetailedView;
GO
-- Get only valid dates
SELECT * FROM DateTypeTestDetailedView 
WHERE IsValidDateTime = 1 
   OR IsValidText = 1 
   OR IsValidSysVarchar = 1;
GO

-- Get invalid dates
SELECT * FROM DateTypeTestDetailedView 
WHERE IsValidDateTime = 0 
   OR IsValidText = 0 
   OR IsValidSysVarchar = 0;
GO
