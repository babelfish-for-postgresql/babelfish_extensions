...
-- create view babel_5512_upgrade_v4 as select case 1 when 1 then cast(5.5 as DECIMAL(10,2)) else cast(6.43 as smallmoney) end
-- GO

-- create view babel_5512_upgrade_v5 as select CAST(123.45 AS NUMERIC(5,2)) + CAST(678.90 AS MONEY) as bsc
-- GO
