...
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE smalldatetime_col <> CAST('2023-06-13' AS DATE);
    RETURN @count;
END
GO
...
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE smalldatetime_col <> CAST('2023-06-15' AS DATE);
    RETURN @count;
END
GO
...
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE smalldatetime_col <> CAST('2023-06-17' AS DATE);
    RETURN @count;
END
GO
...
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE CAST('2023-06-13' AS DATE) <> smalldatetime_col;
    RETURN @count;
END
GO
...
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE CAST('2023-06-15' AS DATE) <> smalldatetime_col;
    RETURN @count;
END
GO
...
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE CAST('2023-06-17' AS DATE) <> smalldatetime_col;
    RETURN @count;
END
GO
...
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE smalldatetime_col < CAST('2023-06-14' AS DATE);
    RETURN @count;
END
GO
...
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE smalldatetime_col <= CAST('2023-06-18' AS DATE) AND smalldatetime_col >= CAST('2023-06-16' AS DATE);
    RETURN @count;
END
GO

CREATE FUNCTION test_smalldatetime_date_f10() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_smalldatetime_date_f11() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE smalldatetime_col > CAST('2023-06-16' AS DATE);
    RETURN @count;
END
GO

CREATE FUNCTION test_smalldatetime_date_f12() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_smalldatetime_date_f13() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE smalldatetime_col BETWEEN CAST('2023-06-16' AS DATE) AND CAST('2023-06-18' AS DATE);
    RETURN @count;
END
GO

CREATE FUNCTION test_smalldatetime_date_f14() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_smalldatetime_date_f15() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE CAST('2023-06-14' AS DATE) > smalldatetime_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_smalldatetime_date_f16() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_smalldatetime_date_f17() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE CAST('2023-06-16' AS DATE) <= smalldatetime_col AND CAST('2023-06-18' AS DATE) >= smalldatetime_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_smalldatetime_date_f18() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_smalldatetime_date_f19() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM smalldate_date_cmp_t1 WHERE CAST('2023-06-16' AS DATE) < smalldatetime_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_smalldatetime_date_f20() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_date_smalldatetime_f1() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE date_col <> CAST('2023-06-13' AS SMALLDATETIME);
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f2() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE date_col <> CAST('2023-06-15' AS SMALLDATETIME);
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f3() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE date_col <> CAST('2023-06-17' AS SMALLDATETIME);
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f4() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE CAST('2023-06-13' AS SMALLDATETIME) <> date_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f5() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE CAST('2023-06-15' AS SMALLDATETIME) <> date_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f6() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE CAST('2023-06-17' AS SMALLDATETIME) <> date_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f7() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE date_col < CAST('2023-06-14' AS SMALLDATETIME);
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f8() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_date_smalldatetime_f9() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE date_col <= CAST('2023-06-18' AS SMALLDATETIME) AND date_col >= CAST('2023-06-16' AS SMALLDATETIME);
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f10() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_date_smalldatetime_f11() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE date_col > CAST('2023-06-16' AS SMALLDATETIME);
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f12() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_date_smalldatetime_f13() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE date_col BETWEEN CAST('2023-06-16' AS SMALLDATETIME) AND CAST('2023-06-18' AS SMALLDATETIME);
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f15() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE CAST('2023-06-14' AS SMALLDATETIME) > date_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f16() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_date_smalldatetime_f17() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE CAST('2023-06-16' AS SMALLDATETIME) <= date_col AND CAST('2023-06-18' AS SMALLDATETIME) >= date_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f18() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
...
CREATE FUNCTION test_date_smalldatetime_f19() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
    SELECT @count = COUNT(*) FROM date_smalldatetime_cmp_t1 WHERE CAST('2023-06-16' AS SMALLDATETIME) < date_col;
    RETURN @count;
END
GO

CREATE FUNCTION test_date_smalldatetime_f20() 
RETURNS INT 
AS
BEGIN
    DECLARE @count INT;
