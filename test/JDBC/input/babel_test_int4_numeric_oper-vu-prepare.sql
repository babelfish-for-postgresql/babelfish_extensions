...
-- tsql
create procedure test_int_numeric_p0 as
select count(*) from test_int_numeric_vu where a = 1.0;
GO

create procedure test_int_numeric_p00 as
select count(*) from test_int_numeric_vu where 1.0 = a;
GO
...
-- tsql
create view test_int_numeric_v0 as
select count(*) from test_int_numeric_vu where a = 1.0;
GO

create view test_int_numeric_v00 as
select count(*) from test_int_numeric_vu where 1.0 = a;
GO
...
-- tsql
create function test_int_numeric_f0() returns int as
begin return (select count(*) from test_int_numeric_vu where a = 1.0) end;
GO

create function test_int_numeric_f00() returns int as
begin return (select count(*) from test_int_numeric_vu where 1.0 = a) end;
GO

create function test_int_numeric_f1() returns int as
begin return (select count(*) from test_int_numeric_vu where a IS NULL) end;
GO

-- seq scan
create function test_int_numeric_f2() returns int as
begin return (select count(*) from test_int_numeric_vu where a <> 5.0) end;
GO

create function test_int_numeric_f3() returns int as
begin return (select count(*) from test_int_numeric_vu where 5.0 <> a) end;
GO

-- index scan on < and >
create function test_int_numeric_f4() returns int as
begin return (select count(*) from test_int_numeric_vu where a < 5.0) end;
GO

create function test_int_numeric_f5() returns int as
begin return (select count(*) from test_int_numeric_vu where 5.0 > a) end;
GO

create function test_int_numeric_f6() returns int as
begin return (select count(*) from test_int_numeric_vu where a < -2147483648.0) end;
GO

create function test_int_numeric_f7() returns int as
begin return (select count(*) from test_int_numeric_vu where -2147483648.0 > a) end;
GO

create function test_int_numeric_f8() returns int as
begin return (select count(*) from test_int_numeric_vu where a <= 5.0) end;
GO

create function test_int_numeric_f9() returns int as
begin return (select count(*) from test_int_numeric_vu where 5.0 >= a) end;
GO

create function test_int_numeric_f10() returns int as
begin return (select count(*) from test_int_numeric_vu where a > 999995.0) end;
GO

create function test_int_numeric_f11() returns int as
begin return (select count(*) from test_int_numeric_vu where 999995.0 < a) end;
GO

create function test_int_numeric_f12() returns int as
begin return (select count(*) from test_int_numeric_vu where a >= 999995.0) end;
GO

create function test_int_numeric_f13() returns int as
begin return (select count(*) from test_int_numeric_vu where 999995.0 <= a) end;
GO

create function test_int_numeric_f14() returns int as
begin return (select count(*) from test_int_numeric_vu where a > 2147483647.0) end;
go

create function test_int_numeric_f15() returns int as
begin return (select count(*) from test_int_numeric_vu where 2147483647.0 < a) end;
go

-- seq scan on < and >
create function test_int_numeric_f16() returns int as
begin return (select count(*) from test_int_numeric_vu where a > 5.0) end;
GO

create function test_int_numeric_f17() returns int as
begin return (select count(*) from test_int_numeric_vu where 5.0 < a) end;
GO

-- index scan for BETWEEN
create function test_int_numeric_f18() returns int as
begin return (select count(*) from test_int_numeric_vu where a between 5.0 and 10.0) end;
GO

-- seq scan for BETWEEN
create function test_int_numeric_f19() returns int as
begin return (select count(*) from test_int_numeric_vu where a between 5.0 and 999999.0) end;
GO

-- mix of int op numeric and int op int
create function test_int_numeric_f20() returns int as
begin return (select count(*) from test_int_numeric_vu where (a between 5.0 and 999999.0) and a = 10) end;
GO

create function test_int_numeric_f21() returns int as
begin return (select count(*) from test_int_numeric_vu where a > 5.0 and a < 7) end;
Go

create function test_int_numeric_f22() returns int as
begin return (select count(*) from test_int_numeric_vu where 5.0 < a and 7 > a) end;
Go

-- shouldn't be any regression on int op int operators

-- seq scan
create function test_int_numeric_f23() returns int as
begin return (select count(*) from test_int_numeric_vu where a <> 5) end;
GO

-- index scan on < and >
create function test_int_numeric_f24() returns int as
begin return (select count(*) from test_int_numeric_vu where a < 5) end;
GO

create function test_int_numeric_f25() returns int as
begin return (select count(*) from test_int_numeric_vu where a < -2147483648) end;
GO

create function test_int_numeric_f26() returns int as
begin return (select count(*) from test_int_numeric_vu where a <= 5) end;
GO

create function test_int_numeric_f27() returns int as
begin return (select count(*) from test_int_numeric_vu where a > 999995) end;
GO

create function test_int_numeric_f28() returns int as
begin return (select count(*) from test_int_numeric_vu where a >= 999995) end;
GO

create function test_int_numeric_f29() returns int as
begin return (select count(*) from test_int_numeric_vu where a > 2147483647) end;
go

-- seq scan on < and >
create function test_int_numeric_f30() returns int as
begin return (select count(*) from test_int_numeric_vu where a > 5) end;
GO

-- index scan for BETWEEN
create function test_int_numeric_f31() returns int as
begin return (select count(*) from test_int_numeric_vu where a between 5 and 10) end;
GO

-- seq scan for BETWEEN
create function test_int_numeric_f32() returns int as
begin return (select count(*) from test_int_numeric_vu where a between 5 and 999999) end;
GO

-- table constraints
create table test_int_numeric_t1(
    a int,
    b int,
    c int,
    d int,
...
create table test_int_numeric_t2(
    a numeric,
    b numeric,
    c numeric,
    d numeric,
