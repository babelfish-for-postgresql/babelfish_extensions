...
/*
* ------------------------------------------------------------------------------------
*  Update  + update inside update trigger
* ------------------------------------------------------------------------------------
*/
...
-- Test Case 17: AFTER trigger that updates the same row
...
/*
* ------------------------------------------------------------------------------------
*  Update  + delete inside update trigger
* ------------------------------------------------------------------------------------
*/
...
-- CREATE TRIGGER tr_EPQTest_After_Update_Complex
-- ON EPQTest
-- AFTER UPDATE
-- AS
-- BEGIN
...
--     UPDATE EPQTest 
--     SET Value = Value + (SELECT COUNT(*) FROM inserted WHERE inserted.ID = EPQTest.ID)
--     WHERE ID IN (SELECT ID FROM inserted);
-- END;
-- GO
...
/*
* ------------------------------------------------------------------------------------
*  Delete  + delete inside delete trigger
* ------------------------------------------------------------------------------------
*/
...
/*
* ------------------------------------------------------------------------------------
*  Delete  + update inside delete trigger
* ------------------------------------------------------------------------------------
*/
...
/*
* ------------------------------------------------------------------------------------
*  Delete  + delete inside insert trigger
* ------------------------------------------------------------------------------------
*/
...
-- Test Case 22: UPDATE with OUTPUT INTO and triggers
