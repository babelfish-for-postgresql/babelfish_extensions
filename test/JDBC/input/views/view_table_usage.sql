...
create table view_table_usage_tb1(view_table_usage_c1 int, 
view_table_usage_c2 char, view_table_usage_c3 varchar);
go

create table view_table_usage_tb2(view_table_usage_c4 char, 
view_table_usage_c5 char, view_table_usage_c6 int);
go
