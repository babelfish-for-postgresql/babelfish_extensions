...
TEST_F(PSQL_DataTypes_Sql_Variant, Update_Success) {
  ...
  testUpdateSuccess(ServerType::MSSQL, BBF_TABLE_NAME, COL1_NAME, COL2_NAME, CASTED_UPDATED_VALUES, UPDATED_VALUES, true, false);
  testUpdateSuccess(ServerType::PSQL, PG_TABLE_NAME, COL1_NAME, COL2_NAME, CASTED_UPDATED_VALUES, UPDATED_VALUES, true, false);
