...
TEST_F(PSQL_DataTypes_Xml, Insertion_Failure) {
  vector<string> inserted_values = {
    FAILURE_XML
  };
  ...
  testInsertionFailure(ServerType::MSSQL, BBF_TABLE_NAME, COL1_NAME, inserted_values, false);
  testInsertionFailure(ServerType::PSQL, BBF_TABLE_NAME, COL1_NAME, inserted_values, false);
