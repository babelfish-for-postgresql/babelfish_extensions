...
TEST_F(PSQL_DataTypes_Geography, Insertion_Success) {
  const vector<string> INSERTED_VALUES = {
    ...
    "(geography::STGeomFromText('Point(47.65100 -22.34900 NULL)', 4326))", 
    "(geography::STGeomFromText('Point(47.65100 -22.34900 NULL NULL)', 4326))", 
    "(geography::STGeomFromText('Point(47.65100 -22.34900 3.0)', 4326))",
    "(geography::STGeomFromText('Point(47.65100 -22.34900 3.0 NULL)', 4326))",
    "(geography::STGeomFromText('Point(47.65100 -22.34900 NULL 4.0)', 4326))",
    "(geography::STGeomFromText('Point(47.65100 -22.34900 3.0 4.0)', 4326))",
    "(geography::STGeomFromText('Point EMPTY', 4326))"
  };
