...
TEST_F(MSSQL_Data_Types, Geography) {
  ...
  const vector<string> INSERTED_VALUES = {
    ...
    "(geography::STGeomFromText('LINESTRING(3 5, 2 4)', 4326),14)",
    "(geography::STGeomFromText('LINESTRING(1 3, 5 7, 4 5 NULL NULL)', 4326),15)",
    "(geography::STGeomFromText('LINESTRING(3 5 4, 2 4 7)', 4326),16)",
    "(geography::STGeomFromText('LINESTRING(1 3 2, 5 7 6 , 4 5)', 4326),17)",
    "(geography::STGeomFromText('LINESTRING(3 5  NULL 4, 2 4 )', 4326),18)",
    "(geography::STGeomFromText('LINESTRING(1 3 NULL 3, 5 7 NULL 5 , 4 5)', 4326),19)",
    "(geography::STGeomFromText('LINESTRING(3 5 4 5, 2 4 7 2)', 4326),20)",
    "(geography::STGeomFromText('LINESTRING(2 -3 -5 -10, 4 -1, 3 -2  5 NULL, 4 6 3 5, 3 6)', 4326),21)",
    "(geography::STGeomFromText('LINESTRING(4 5 2, 1 1 3, 2 2 5, 3 3 2 NULL , 4 4 NULL 4, 5 5, 6 6 NULL 5 , 7 7 NULL NULL , 8 8, 9 9 4 NULL, 10 10 4)', 4326),22)",
