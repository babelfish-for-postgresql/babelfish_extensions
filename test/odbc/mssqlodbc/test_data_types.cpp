...
TEST_F(MSSQL_Data_Types, Geometry) {
  ...
  const vector<string> INSERTED_VALUES = {
    ...
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 3.0)', 4326), 7)", 
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 NULL 4.0)', 4326), 8)",
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 3.0 4.0)', 4326), 9)",
    "(geometry::STGeomFromText('Point EMPTY', 4326), 10)"
  };
...
TEST_F(MSSQL_Data_Types, Geography) {
  ...
  const vector<string> INSERTED_VALUES = {
    ...
    "(geography::STGeomFromText('Point(47.65100 -22.34900 3.0)', 4326), 7)", 
    "(geography::STGeomFromText('Point(47.65100 -22.34900 NULL 4.0)', 4326), 8)",
    "(geography::STGeomFromText('Point(47.65100 -22.34900 3.0 4.0)', 4326), 9)",
    "(geography::STGeomFromText('Point EMPTY', 4326), 10)"
  };
