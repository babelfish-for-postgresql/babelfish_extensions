...
TEST_F(MSSQL_Data_Types, Geometry) {
  ...
  const vector<string> INSERTED_VALUES = {
    ...
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 NULL)', 4326),7)", 
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 NULL NULL)', 4326),8)", 
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 3.0)', 4326),9)",
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 3.0 NULL)', 4326),10)",
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 NULL 4.0)', 4326),11)",
    "(geometry::STGeomFromText('Point(47.65100 -22.34900 3.0 4.0)', 4326),12)",
    "(geometry::STGeomFromText('Point EMPTY', 4326),13)",
    "(geometry::STGeomFromText('LINESTRING(3 5, 2 4)', 4326),14)",
    "(geometry::STGeomFromText('LINESTRING(1 3, 5 7, 4 5 NULL NULL)', 4326),15)",
    "(geometry::STGeomFromText('LINESTRING(3 5 4, 2 4 7)', 4326),16)",
    "(geometry::STGeomFromText('LINESTRING(1 3 2, 5 7 6 , 4 5)', 4326),17)",
    "(geometry::STGeomFromText('LINESTRING(3 5  NULL 4, 2 4 )', 4326),18)",
    "(geometry::STGeomFromText('LINESTRING(1 3 NULL 3, 5 7 NULL 5 , 4 5)', 4326),19)",
    "(geometry::STGeomFromText('LINESTRING(3 5 4 5, 2 4 7 2)', 4326),20)",
    "(geometry::STGeomFromText('LINESTRING(2 -3 -5 -10, 4 -1, 3 -2  5 NULL, 4 6 3 5, 3 6)', 4326),21)",
    "(geometry::STGeomFromText('LINESTRING(4 5 2, 1 1 3, 2 2 5, 3 3 2 NULL , 4 4 NULL 4, 5 5, 6 6 NULL 5 , 7 7 NULL NULL , 8 8, 9 9 4 NULL, 10 10 4)', 4326),22)",
    "(geometry::STGeomFromText('LINESTRING EMPTY', 4326),23)"
  };
  ...
  vector<vector<string>> expectedValues = {
    {"E6100000010C17D9CEF753D34740D34D6210585936C0", "E6100000010C000000000000F03F0000000000000040", "00000000010C17D9CEF753D34740D34D6210585936C0", 
      ...
      "E610000001140000000000000840000000000000144000000000000000400000000000001040",
      "E6100000010403000000000000000000F03F000000000000084000000000000014400000000000001C400000000000001040000000000000144001000000010000000001000000FFFFFFFF0000000002",
      "E61000000115000000000000084000000000000014400000000000000040000000000000104000000000000010400000000000001C40",
      "E6100000010503000000000000000000F03F000000000000084000000000000014400000000000001C400000000000001040000000000000144000000000000000400000000000001840000000000000F8FF01000000010000000001000000FFFFFFFF0000000002",
      "E6100000011600000000000008400000000000001440000000000000004000000000000010400000000000001040000000000000F8FF",
      "E6100000010603000000000000000000F03F000000000000084000000000000014400000000000001C400000000000001040000000000000144000000000000008400000000000001440000000000000F8FF01000000010000000001000000FFFFFFFF0000000002",
      "E61000000117000000000000084000000000000014400000000000000040000000000000104000000000000010400000000000001C4000000000000014400000000000000040",
      "",
      "",
      "E61000000104000000000000000001000000FFFFFFFFFFFFFFFF02"
    }
  };
...
TEST_F(MSSQL_Data_Types, Geography) {
  ...
  const vector<string> INSERTED_VALUES = {
    ...
    "(geography::STGeomFromText('Point(47.65100 -22.34900 NULL)', 4326),7)", 
    "(geography::STGeomFromText('Point(47.65100 -22.34900 NULL NULL)', 4326),8)", 
    "(geography::STGeomFromText('Point(47.65100 -22.34900 3.0)', 4326),9)",
    "(geography::STGeomFromText('Point(47.65100 -22.34900 3.0 NULL)', 4326),10)",
    "(geography::STGeomFromText('Point(47.65100 -22.34900 NULL 4.0)', 4326),11)",
    "(geography::STGeomFromText('Point(47.65100 -22.34900 3.0 4.0)', 4326),12)",
    "(geography::STGeomFromText('Point EMPTY', 4326),13)",
    "(geography::STGeomFromText('LINESTRING(5 3, 4 2)', 4326),14)",
    "(geography::STGeomFromText('LINESTRING(3 1, 7 5, 5 4 NULL NULL)', 4326),15)",
    "(geography::STGeomFromText('LINESTRING(5 3 4, 4 2 7)', 4326),16)",
    "(geography::STGeomFromText('LINESTRING(3 1 2, 7 5 6 , 5 4)', 4326),17)",
    "(geography::STGeomFromText('LINESTRING(5 3  NULL 4, 4 2 )', 4326),18)",
    "(geography::STGeomFromText('LINESTRING(3 1 NULL 3, 7 5 NULL 5 , 5 4)', 4326),19)",
    "(geography::STGeomFromText('LINESTRING(5 3 4 5, 4 2 7 2)', 4326),20)",
    "(geography::STGeomFromText('LINESTRING(-3 2 -5 -10, -1 4, -2 3  5 NULL, 6 4 3 5, 6 3)', 4326),21)",
    "(geography::STGeomFromText('LINESTRING(5 4 2, 1 1 3, 2 2 5, 3 3 2 NULL , 4 4 NULL 4, 5 5, 6 6 NULL 5 , 7 7 NULL NULL , 8 8, 9 9 4 NULL, 10 10 4)', 4326),22)",
    "(geography::STGeomFromText('LINESTRING EMPTY', 4326),23)"
  };
  ...
  vector<vector<string>> expectedValues = {
    {"E6100000010CD34D6210585936C017D9CEF753D34740", "E6100000010C0000000000000040000000000000F03F", NULL_STR, "E6100000010C0000000000000040000000000000F03F", 
      ...
      "E6100000010CD34D6210585936C017D9CEF753D34740", 
      "E6100000010DD34D6210585936C017D9CEF753D347400000000000000840",
      "E6100000010DD34D6210585936C017D9CEF753D347400000000000000840",
      "E6100000010ED34D6210585936C017D9CEF753D347400000000000001040",
      "E6100000010FD34D6210585936C017D9CEF753D3474000000000000008400000000000001040",
      "E61000000104000000000000000001000000FFFFFFFFFFFFFFFF01",
      "E610000001140000000000000840000000000000144000000000000000400000000000001040",
      "E6100000010403000000000000000000F03F000000000000084000000000000014400000000000001C400000000000001040000000000000144001000000010000000001000000FFFFFFFF0000000002",
      "E61000000115000000000000084000000000000014400000000000000040000000000000104000000000000010400000000000001C40",
